...
public class TestPDIndexedRickGen {
    ...
    public void test_toRGBImage_PO_0b9f7da78f0f40dda41ec490c4ea3164() throws Exception {
        // Arrange
        org.apache.pdfbox.pdmodel.graphics.color.PDIndexed receivingObject = deserializeObjectFromFile("org.apache.pdfbox.pdmodel.graphics.color.PDIndexed.toRGBImage1-receiving.xml");
