...
public class TestViaInstructionRickGen {
    ...
    public void test_getTurnDescription_OO_8bfef00575ed46db9b0556a65c2636e1() throws Exception {
        // Arrange
        com.graphhopper.util.ViaInstruction receivingObject = deserializeObjectFromFile("com.graphhopper.util.ViaInstruction.getTurnDescription1-receiving.xml");
        Translation mockTranslation = Mockito.mock(Translation.class);
        Mockito.when(mockTranslation.tr(eq("stopover"),   (java.lang.Object[]) any())).thenReturn("waypoint 1");
        // Act
    ...
    public void test_getTurnDescription_PO_8bfef00575ed46db9b0556a65c2636e1() throws Exception {
        ...
        // Assert
        Mockito.verify(mockTranslation, Mockito.atLeastOnce()).tr(eq("stopover"),   (java.lang.Object[]) any());
    }
