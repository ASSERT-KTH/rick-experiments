...
public class TestFinishInstructionRickGen {
    ...
    public void test_getTurnDescription_OO_f4925d65c622402e98befa313e740ccb() throws Exception {
        // Arrange
        com.graphhopper.util.FinishInstruction receivingObject = deserializeObjectFromFile("com.graphhopper.util.FinishInstruction.getTurnDescription1-receiving.xml");
        Translation mockTranslation = Mockito.mock(Translation.class);
        Mockito.when(mockTranslation.tr(eq("finish"),   (java.lang.Object[]) any())).thenReturn("arrive at destination");
        // Act
    ...
    public void test_getTurnDescription_PO_f4925d65c622402e98befa313e740ccb() throws Exception {
        ...
        // Assert
        Mockito.verify(mockTranslation, Mockito.atLeastOnce()).tr(eq("finish"),   (java.lang.Object[]) any());
    }
