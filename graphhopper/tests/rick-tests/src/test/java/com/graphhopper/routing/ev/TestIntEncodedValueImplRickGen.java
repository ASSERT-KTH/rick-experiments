...
public class TestIntEncodedValueImplRickGen {
    ...
    public void test_init_OO_662703e4e83742d7975c6e2c1fcd6053() throws Exception {
        // Arrange
        com.graphhopper.routing.ev.SimpleBooleanEncodedValue receivingObject = deserializeObjectFromFile("com.graphhopper.routing.ev.IntEncodedValueImpl.init1-receiving.xml");
