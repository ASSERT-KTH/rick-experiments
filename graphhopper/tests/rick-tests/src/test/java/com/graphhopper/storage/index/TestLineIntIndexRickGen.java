...
public class TestLineIntIndexRickGen {
    ...
    public void test_loadExisting_OO_e5ef2f54a4cc4956be11115f9faf6853() throws Exception {
        // Arrange
        com.graphhopper.storage.index.LineIntIndex receivingObject = deserializeObjectFromFile("com.graphhopper.storage.index.LineIntIndex.loadExisting1-receiving.xml");
