...
public class TestRoundaboutInstructionRickGen {
    ...
    public void test_getTurnDescription_OO_d2827aeb41c446acb04843a63ab22e8f() throws Exception {
        // Arrange
        com.graphhopper.util.RoundaboutInstruction receivingObject = deserializeObjectFromFile("com.graphhopper.util.RoundaboutInstruction.getTurnDescription1-receiving.xml");
        Translation mockTranslation = Mockito.mock(Translation.class);
        Mockito.when(mockTranslation.tr(eq("roundabout_exit_onto"),   (java.lang.Object[]) any())).thenReturn("At roundabout, take exit 2 onto Kungsgatan");
        // Act
    ...
    public void test_getTurnDescription_PO_d2827aeb41c446acb04843a63ab22e8f() throws Exception {
        ...
        // Assert
        Mockito.verify(mockTranslation, Mockito.atLeastOnce()).tr(eq("roundabout_exit_onto"),   (java.lang.Object[]) any());
    }
