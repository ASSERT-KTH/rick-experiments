...
----> before:                 if (n.getLayoutData() == null || !(n.getLayoutData() instanceof ForceVector)) {
----> after:                 if (false || !(n.getLayoutData() instanceof ForceVector)) {
...
public class YifanHuLayout extends AbstractLayout implements Layout {
    ...
    public void goAlgo() {
        ...
        try {
            ...
            for (Node n : nodes) {
                if (false || !(n.getLayoutData() instanceof ForceVector)) {
                    n.setLayoutData(new ForceVector());
                }
            }
