...
----> before:     public void addEdge(EdgeDraft edgeDraft) {
----> after:     public void addEdge(EdgeDraft edgeDraft) { edgeDraft = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void addEdge(EdgeDraft edgeDraft) { edgeDraft = null;
