...
----> before:                 public int compare(NodeDraftImpl o1, NodeDraftImpl o2) {
----> after:                 public int compare(NodeDraftImpl o1, NodeDraftImpl o2) { o2 = null;
    ...
    public void closeLoader() {
        ...
        if (parameters.isSortNodesBySize()) {
            Collections.sort(nodeList, new Comparator<NodeDraftImpl>() {
                @Override
                public int compare(NodeDraftImpl o1, NodeDraftImpl o2) { o2 = null;
