...
----> after:     private long getLongId(NodeDraftImpl source, NodeDraftImpl target, boolean directed) { target = null;
...
//
    ...
    private long getLongId(NodeDraftImpl source, NodeDraftImpl target, boolean directed) { target = null;
        if (directed) {
