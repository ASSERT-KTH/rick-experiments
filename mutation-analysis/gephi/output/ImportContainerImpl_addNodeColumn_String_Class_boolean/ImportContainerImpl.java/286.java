...
----> after:     public ColumnDraft addNodeColumn(String key, Class typeClass, boolean dynamic) { key = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft addNodeColumn(String key, Class typeClass, boolean dynamic) { key = null;
