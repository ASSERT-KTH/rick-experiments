...
----> before:     private EdgeDraftImpl getOpposite(EdgeDraftImpl edge) {
----> after:     private EdgeDraftImpl getOpposite(EdgeDraftImpl edge) { edge = null;
...
//
    ...
    private EdgeDraftImpl getOpposite(EdgeDraftImpl edge) { edge = null;
