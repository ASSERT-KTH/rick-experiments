...
----> before:     public void setElementIdType(ElementIdType type) {
----> after:     public void setElementIdType(ElementIdType type) { type = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void setElementIdType(ElementIdType type) { type = null;
