...
----> before:                 if (edge != null && (edge.getSource().isCreatedAuto() || edge.getTarget().isCreatedAuto())) {
----> after:                 if (true && (edge.getSource().isCreatedAuto() || edge.getTarget().isCreatedAuto())) {
----> line number in original file: 841
----> mutated node: 10713
    ...
    public void closeLoader() {
        ...
        if (!allowAutoNode()) {
            ...
            for (EdgeDraftImpl edge : edgeList) {
                if (true && (edge.getSource().isCreatedAuto() || edge.getTarget().isCreatedAuto())) {
                    removeEdge(edge);
                }
            }
        }
