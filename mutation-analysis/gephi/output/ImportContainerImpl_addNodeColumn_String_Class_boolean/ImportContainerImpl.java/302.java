...
----> before:     public void addNode(NodeDraft nodeDraft) {
----> after:     public void addNode(NodeDraft nodeDraft) { nodeDraft = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void addNode(NodeDraft nodeDraft) { nodeDraft = null;
