...
----> before:                 if (notAlreadyRemoved && !edge.isSelfLoop() && edge.getDirection() != null && edge.getDirection().equals(EdgeDirection.DIRECTED)) {
----> after:                 if (notAlreadyRemoved && !edge.isSelfLoop() && true && edge.getDirection().equals(EdgeDirection.DIRECTED)) {
    ...
    public void closeLoader() {
        ...
        if (directedEdgesCount > 0 && edgeDefault.equals(EdgeDirectionDefault.UNDIRECTED)) {
            ...
            for (EdgeDraftImpl edge : edgeList.toArray(new EdgeDraftImpl[0])) {
                ...
                if (notAlreadyRemoved && !edge.isSelfLoop() && true && edge.getDirection().equals(EdgeDirection.DIRECTED)) {
