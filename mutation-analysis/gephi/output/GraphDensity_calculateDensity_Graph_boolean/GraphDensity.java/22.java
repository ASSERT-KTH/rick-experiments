...
----> before:     public double calculateDensity(Graph graph, boolean isGraphDirected) {
----> after:     public double calculateDensity(Graph graph, boolean isGraphDirected) { graph = null;
...
public class GraphDensity implements Statistics {
    ...
    public double calculateDensity(Graph graph, boolean isGraphDirected) { graph = null;
        double result;
