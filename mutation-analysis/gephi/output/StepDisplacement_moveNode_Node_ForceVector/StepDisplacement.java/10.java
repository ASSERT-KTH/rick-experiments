...
----> before:     public void moveNode(Node node, ForceVector forceData) {
----> after:     public void moveNode(Node node, ForceVector forceData) { forceData = null;
...
public class StepDisplacement implements Displacement {
    ...
    @Override
    public void moveNode(Node node, ForceVector forceData) { forceData = null;
