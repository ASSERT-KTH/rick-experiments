...
----> before:     public void setTimeZone(DateTimeZone timeZone) {
----> after:     public void setTimeZone(DateTimeZone timeZone) { timeZone = null;
----> line number in original file: 486
----> mutated node: 2621
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void setTimeZone(DateTimeZone timeZone) { timeZone = null;
