...
----> before:     public boolean hasNodeColumn(String key) {
----> after:     public boolean hasNodeColumn(String key) { key = null;
----> line number in original file: 572
----> mutated node: 2677
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public boolean hasNodeColumn(String key) { key = null;
