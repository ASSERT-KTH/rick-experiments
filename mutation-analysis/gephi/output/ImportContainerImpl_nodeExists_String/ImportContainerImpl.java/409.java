...
----> before:                     return new Float(o2 != null ? o2.getSize() : 0f).compareTo(o1 != null ? o1.getSize() : 0f);
----> after:                     return new Float(o2 != null ? o2.getSize() : 0f).compareTo(true ? o1.getSize() : 0f);
----> line number in original file: 852
----> mutated node: 14073
        ...
        if (parameters.isSortNodesBySize()) {
            Collections.sort(nodeList, new Comparator<NodeDraftImpl>() {
                ...
                public int compare(NodeDraftImpl o1, NodeDraftImpl o2) {
                    return new Float(o2 != null ? o2.getSize() : 0f).compareTo(true ? o1.getSize() : 0f);
                }
            });
        }
