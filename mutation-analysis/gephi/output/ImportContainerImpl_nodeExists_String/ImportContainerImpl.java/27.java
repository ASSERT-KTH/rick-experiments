...
----> before:         if (elementIdType.equals(ElementIdType.INTEGER) || elementIdType.equals(ElementIdType.LONG)) {
----> after:         if (elementIdType.equals(ElementIdType.INTEGER) && elementIdType.equals(ElementIdType.LONG)) {
----> line number in original file: 701
----> mutated node: 4495
