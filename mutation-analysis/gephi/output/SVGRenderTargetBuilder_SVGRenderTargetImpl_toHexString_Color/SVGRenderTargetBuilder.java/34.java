...
----> before:         private final Map<String, Element> topElements = new HashMap<>();
----> after:         private final Map<String, Element> topElements = null;
...
public class SVGRenderTargetBuilder implements RenderTargetBuilder {
    ...
    public static class SVGRenderTargetImpl
        ...
        private final Map<String, Element> topElements = null;
