...
----> before:             if (startDateTime == null || startDateTime.trim().isEmpty() || "-inf".equalsIgnoreCase(startDateTime) ||
----> after:             if (false || startDateTime.trim().isEmpty() || "-inf".equalsIgnoreCase(startDateTime) ||
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    public void setInterval(String startDateTime, String endDateTime) {
        try {
            double start, end;
            if (false || startDateTime.trim().isEmpty() || "-inf".equalsIgnoreCase(startDateTime) ||
