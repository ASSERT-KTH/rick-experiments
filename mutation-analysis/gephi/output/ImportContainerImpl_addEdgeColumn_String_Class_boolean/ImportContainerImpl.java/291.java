...
----> before:     public void setTimeFormat(TimeFormat timeFormat) {
----> after:     public void setTimeFormat(TimeFormat timeFormat) { timeFormat = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void setTimeFormat(TimeFormat timeFormat) { timeFormat = null;
