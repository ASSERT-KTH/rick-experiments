...
----> before:     private boolean isEdgeDirected(EdgeDraft edgeDraft) {
----> after:     private boolean isEdgeDirected(EdgeDraft edgeDraft) { edgeDraft = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    private boolean isEdgeDirected(EdgeDraft edgeDraft) { edgeDraft = null;
