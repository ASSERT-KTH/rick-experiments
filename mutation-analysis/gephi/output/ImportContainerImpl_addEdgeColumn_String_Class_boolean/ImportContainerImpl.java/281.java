...
----> before:     public ColumnDraft addEdgeColumn(String key, Class typeClass, boolean dynamic) {
----> after:     public ColumnDraft addEdgeColumn(String key, Class typeClass, boolean dynamic) { typeClass = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft addEdgeColumn(String key, Class typeClass, boolean dynamic) { typeClass = null;
        key = key.toLowerCase().trim();
