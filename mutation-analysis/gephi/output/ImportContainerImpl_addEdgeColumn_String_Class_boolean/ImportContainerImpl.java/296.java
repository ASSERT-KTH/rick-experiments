...
----> before:     private void removeNode(NodeDraftImpl node) {
----> after:     private void removeNode(NodeDraftImpl node) { node = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    private void removeNode(NodeDraftImpl node) { node = null;
