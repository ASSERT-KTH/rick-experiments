...
----> before:                 final boolean notAlreadyRemoved = edge != null
----> after:                 final boolean notAlreadyRemoved = true
----> line number in original file: 814
----> mutated node: 12228
    ...
    public void closeLoader() {
        ...
        if (directedEdgesCount > 0 && edgeDefault.equals(EdgeDirectionDefault.UNDIRECTED)) {
            ...
            for (EdgeDraftImpl edge : edgeList.toArray(new EdgeDraftImpl[0])) {
                final boolean notAlreadyRemoved = true
