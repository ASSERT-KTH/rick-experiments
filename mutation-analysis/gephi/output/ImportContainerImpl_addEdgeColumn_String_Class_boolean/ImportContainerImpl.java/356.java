...
----> before:         for (EdgeDraftImpl edge : new NullFilterIterable<EdgeDraftImpl>(edgeList)) {
----> after:         for (EdgeDraftImpl edge : null) {
----> line number in original file: 736
----> mutated node: 6096
