...
----> before:     public void renderG2D(Item item, G2DTarget target, PreviewProperties properties) {
----> after:     public void renderG2D(Item item, G2DTarget target, PreviewProperties properties) { properties = null;
...
public class NodeRenderer implements Renderer {
    ...
    public void renderG2D(Item item, G2DTarget target, PreviewProperties properties) { properties = null;
        //Params
