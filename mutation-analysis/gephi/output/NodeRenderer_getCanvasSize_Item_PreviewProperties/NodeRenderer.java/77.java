...
----> after:     public void render(Item item, RenderTarget target, PreviewProperties properties) { item = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public void render(Item item, RenderTarget target, PreviewProperties properties) { item = null;
