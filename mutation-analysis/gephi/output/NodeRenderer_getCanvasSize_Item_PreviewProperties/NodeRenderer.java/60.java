...
----> before:     private boolean showNodes(PreviewProperties properties) {
----> after:     private boolean showNodes(PreviewProperties properties) { properties = null;
...
public class NodeRenderer implements Renderer {
    ...
    private boolean showNodes(PreviewProperties properties) { properties = null;
