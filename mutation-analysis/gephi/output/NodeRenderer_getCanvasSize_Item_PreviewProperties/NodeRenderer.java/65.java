...
----> after:     public void renderSVG(Item item, SVGTarget target, PreviewProperties properties) { target = null;
...
public class NodeRenderer implements Renderer {
    ...
    public void renderSVG(Item item, SVGTarget target, PreviewProperties properties) { target = null;
