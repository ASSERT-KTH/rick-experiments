...
----> after:     public void renderG2D(Item item, G2DTarget target, PreviewProperties properties) { target = null;
...
public class NodeRenderer implements Renderer {
    ...
    public void renderG2D(Item item, G2DTarget target, PreviewProperties properties) { target = null;
        //Params
