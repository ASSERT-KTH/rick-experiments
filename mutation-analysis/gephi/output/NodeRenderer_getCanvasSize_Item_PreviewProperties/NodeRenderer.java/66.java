...
----> after:     public void renderSVG(Item item, SVGTarget target, PreviewProperties properties) { item = null;
...
public class NodeRenderer implements Renderer {
    ...
    public void renderSVG(Item item, SVGTarget target, PreviewProperties properties) { item = null;
