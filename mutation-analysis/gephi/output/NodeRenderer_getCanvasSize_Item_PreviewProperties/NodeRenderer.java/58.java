...
----> before:     public boolean isRendererForitem(Item item, PreviewProperties properties) {
----> after:     public boolean isRendererForitem(Item item, PreviewProperties properties) { properties = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public boolean isRendererForitem(Item item, PreviewProperties properties) { properties = null;
