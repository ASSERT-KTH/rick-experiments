...
----> before:     public void preProcess(PreviewModel previewModel) {
----> after:     public void preProcess(PreviewModel previewModel) { previewModel = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public void preProcess(PreviewModel previewModel) { previewModel = null;
    }
