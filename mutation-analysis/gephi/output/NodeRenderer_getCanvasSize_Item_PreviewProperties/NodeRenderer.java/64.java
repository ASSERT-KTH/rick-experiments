...
----> before:     public void renderSVG(Item item, SVGTarget target, PreviewProperties properties) {
----> after:     public void renderSVG(Item item, SVGTarget target, PreviewProperties properties) { properties = null;
...
public class NodeRenderer implements Renderer {
    ...
    public void renderSVG(Item item, SVGTarget target, PreviewProperties properties) { properties = null;
