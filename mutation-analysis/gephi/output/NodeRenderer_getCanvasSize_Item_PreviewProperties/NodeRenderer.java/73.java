...
----> before:     public void postProcess(PreviewModel previewModel, RenderTarget renderTarget, PreviewProperties properties) {
----> after:     public void postProcess(PreviewModel previewModel, RenderTarget renderTarget, PreviewProperties properties) { renderTarget = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public void postProcess(PreviewModel previewModel, RenderTarget renderTarget, PreviewProperties properties) { renderTarget = null;
    }
