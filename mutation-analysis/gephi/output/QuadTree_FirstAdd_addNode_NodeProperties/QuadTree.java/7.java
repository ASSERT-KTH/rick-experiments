...
----> before:     public boolean addInterval(Interval interval) {
----> after:     public boolean addInterval(Interval interval) { interval = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public boolean addInterval(Interval interval) { interval = null;
        throw new UnsupportedOperationException("Not supported.");
    }
