...
----> before:     public void setAttribute(Column column, Object value, double timestamp) {
----> after:     public void setAttribute(Column column, Object value, double timestamp) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(Column column, Object value, double timestamp) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
