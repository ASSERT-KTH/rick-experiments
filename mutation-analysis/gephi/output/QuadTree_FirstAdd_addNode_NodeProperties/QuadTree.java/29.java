...
----> before:     public Object getAttribute(Column column, double timestamp) {
----> after:     public Object getAttribute(Column column, double timestamp) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object getAttribute(Column column, double timestamp) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
