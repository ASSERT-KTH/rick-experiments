...
----> before:     public Object removeAttribute(String key, double timestamp) {
----> after:     public Object removeAttribute(String key, double timestamp) { key = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object removeAttribute(String key, double timestamp) { key = null;
        throw new UnsupportedOperationException("Not supported.");
    }
