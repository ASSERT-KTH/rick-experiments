...
----> before:     public Object removeAttribute(String key) {
----> after:     public Object removeAttribute(String key) { key = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object removeAttribute(String key) { key = null;
        throw new UnsupportedOperationException("Not supported.");
    }
