...
----> before:     public Object removeAttribute(Column column, Interval interval) {
----> after:     public Object removeAttribute(Column column, Interval interval) { interval = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object removeAttribute(Column column, Interval interval) { interval = null;
        throw new UnsupportedOperationException("Not supported.");
    }
