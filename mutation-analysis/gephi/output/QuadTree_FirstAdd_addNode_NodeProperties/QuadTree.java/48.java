...
----> before:     private boolean addToChildren(NodeProperties node) {
----> after:     private boolean addToChildren(NodeProperties node) { node = null;
...
public class QuadTree implements Node {
    ...
    private boolean addToChildren(NodeProperties node) { node = null;
