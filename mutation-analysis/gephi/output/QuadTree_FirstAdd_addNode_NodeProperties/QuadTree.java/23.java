...
----> before:     public Object getAttribute(String key, Interval interval) {
----> after:     public Object getAttribute(String key, Interval interval) { interval = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object getAttribute(String key, Interval interval) { interval = null;
        throw new UnsupportedOperationException("Not supported.");
    }
