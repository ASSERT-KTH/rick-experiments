...
----> after:     public void setAttribute(Column column, Object value, double timestamp) { value = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(Column column, Object value, double timestamp) { value = null;
        throw new UnsupportedOperationException("Not supported.");
    }
