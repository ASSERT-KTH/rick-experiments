...
----> before:     public Object getAttribute(Column column) {
----> after:     public Object getAttribute(Column column) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object getAttribute(Column column) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
