...
----> before:     public void setAttribute(String key, Object value, double timestamp) {
----> after:     public void setAttribute(String key, Object value, double timestamp) { value = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(String key, Object value, double timestamp) { value = null;
        throw new UnsupportedOperationException("Not supported.");
    }
