...
----> after:     public void setAttribute(String key, Object value, Interval interval) { key = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(String key, Object value, Interval interval) { key = null;
        throw new UnsupportedOperationException("Not supported.");
    }
