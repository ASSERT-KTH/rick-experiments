...
----> before:     public Object removeAttribute(Column column, double timestamp) {
----> after:     public Object removeAttribute(Column column, double timestamp) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object removeAttribute(Column column, double timestamp) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
