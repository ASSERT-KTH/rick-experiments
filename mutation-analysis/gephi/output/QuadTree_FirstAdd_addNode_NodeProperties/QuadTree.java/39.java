...
----> before:     public Object removeAttribute(Column column) {
----> after:     public Object removeAttribute(Column column) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object removeAttribute(Column column) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
