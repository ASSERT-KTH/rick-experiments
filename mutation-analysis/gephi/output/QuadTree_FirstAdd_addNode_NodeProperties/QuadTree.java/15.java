...
----> after:     public Object removeAttribute(Column column, Interval interval) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object removeAttribute(Column column, Interval interval) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
