...
----> after:     public void setAttribute(String key, Object value, double timestamp) { key = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(String key, Object value, double timestamp) { key = null;
        throw new UnsupportedOperationException("Not supported.");
    }
