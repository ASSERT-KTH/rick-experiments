...
----> before:     private void assimilateNode(NodeProperties node) {
----> after:     private void assimilateNode(NodeProperties node) { node = null;
...
public class QuadTree implements Node {
    ...
    private void assimilateNode(NodeProperties node) { node = null;
