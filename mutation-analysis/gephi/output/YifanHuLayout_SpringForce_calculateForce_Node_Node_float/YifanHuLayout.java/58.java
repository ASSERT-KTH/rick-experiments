...
----> before:             setOptimalDistance((float) (Math.pow(getRelativeStrength(), 1.0 / 3) * getAverageEdgeLength(graph)));
----> after:             setOptimalDistance((float) (Math.pow(getRelativeStrength(), 1.0 / 3) / getAverageEdgeLength(graph)));
