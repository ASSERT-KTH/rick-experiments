...
----> before:     public float getAverageEdgeLength(Graph graph) {
----> after:     public float getAverageEdgeLength(Graph graph) { graph = null;
...
public class YifanHuLayout extends AbstractLayout implements Layout {
    ...
    public float getAverageEdgeLength(Graph graph) { graph = null;
        float edgeLength = 0;
        int count = 1;
