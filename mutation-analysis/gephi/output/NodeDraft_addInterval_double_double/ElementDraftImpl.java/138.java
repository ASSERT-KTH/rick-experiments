...
----> after:     public void parseAndSetValue(String key, String value, double timestamp) { key = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value, double timestamp) { key = null;
        ColumnDraft column = getColumn(key);
