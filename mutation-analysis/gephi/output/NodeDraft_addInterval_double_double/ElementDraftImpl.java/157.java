...
----> before:     public void setLabelColor(String r, String g, String b) {
----> after:     public void setLabelColor(String r, String g, String b) { b = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void setLabelColor(String r, String g, String b) { b = null;
