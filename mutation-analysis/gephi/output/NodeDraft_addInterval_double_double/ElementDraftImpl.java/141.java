...
----> after:     public void parseAndSetValue(String key, String value, String dateTime) { key = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value, String dateTime) { key = null;
