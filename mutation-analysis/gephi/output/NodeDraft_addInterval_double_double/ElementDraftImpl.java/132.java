...
----> after:     public void parseAndSetValue(String key, String value, double start, double end) { key = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value, double start, double end) { key = null;
        ColumnDraft column = getColumn(key);
