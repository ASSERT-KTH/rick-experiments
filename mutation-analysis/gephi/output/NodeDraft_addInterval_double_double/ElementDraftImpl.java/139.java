...
----> before:     public void parseAndSetValue(String key, String value, String dateTime) {
----> after:     public void parseAndSetValue(String key, String value, String dateTime) { dateTime = null;
----> line number in original file: 323
----> mutated node: 1516
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value, String dateTime) { dateTime = null;
