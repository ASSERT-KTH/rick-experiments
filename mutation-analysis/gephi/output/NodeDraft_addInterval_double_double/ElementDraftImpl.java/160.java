...
----> before:     public void setColor(String r, String g, String b) {
----> after:     public void setColor(String r, String g, String b) { b = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void setColor(String r, String g, String b) { b = null;
