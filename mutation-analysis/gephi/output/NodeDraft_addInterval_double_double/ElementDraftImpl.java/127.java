...
----> after:     public void addInterval(String intervalStartDateTime, String intervalEndDateTime) { intervalEndDateTime = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void addInterval(String intervalStartDateTime, String intervalEndDateTime) { intervalEndDateTime = null;
        double start, end;
