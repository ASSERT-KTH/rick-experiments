...
----> before:     public void parseAndSetValue(String key, String value) {
----> after:     public void parseAndSetValue(String key, String value) { value = null;
----> line number in original file: 303
----> mutated node: 1505
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value) { value = null;
        ColumnDraft column = getColumn(key);
        if (column.isDynamic()) {
