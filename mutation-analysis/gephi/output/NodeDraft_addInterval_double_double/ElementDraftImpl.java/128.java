...
----> before:     public void addInterval(String intervalStartDateTime, String intervalEndDateTime) {
----> after:     public void addInterval(String intervalStartDateTime, String intervalEndDateTime) { intervalStartDateTime = null;
----> line number in original file: 405
----> mutated node: 1583
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void addInterval(String intervalStartDateTime, String intervalEndDateTime) { intervalStartDateTime = null;
        double start, end;
