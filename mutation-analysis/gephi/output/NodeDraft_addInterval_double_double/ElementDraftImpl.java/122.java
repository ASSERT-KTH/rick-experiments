...
----> after:     protected void setAttributeValue(ColumnDraft column, Object value, double timestamp) throws Exception { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    protected void setAttributeValue(ColumnDraft column, Object value, double timestamp) throws Exception { value = null;
        int index = ((ColumnDraftImpl) column).getIndex();
