...
----> before:         if (AttributeUtils.isDynamicType(type) && !TimeSet.class.isAssignableFrom(type)) {
----> after:         if (AttributeUtils.isDynamicType(type) &&  TimeSet.class.isAssignableFrom(type)) {
