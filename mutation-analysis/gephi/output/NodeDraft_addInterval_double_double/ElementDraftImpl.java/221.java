...
----> before:         if (startDateTime == null || startDateTime.isEmpty() || "-inf".equalsIgnoreCase(startDateTime) ||
----> after:         if (false || startDateTime.isEmpty() || "-inf".equalsIgnoreCase(startDateTime) ||
----> line number in original file: 271
----> mutated node: 3976
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    public void setValue(String key, Object value, String startDateTime, String endDateTime) {
        double start, end;
        if (false || startDateTime.isEmpty() || "-inf".equalsIgnoreCase(startDateTime) ||
