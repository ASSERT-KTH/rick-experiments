...
----> before:             clusteringCol = nodeTable.addColumn("clustering", "Clustering Coefficient", Double.class, new Double(0));
----> after:             clusteringCol = nodeTable.addColumn("clustering", "Clustering Coefficient", Double.class, null);
----> line number in original file: 669
----> mutated node: 7447
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private Column initializeAttributeColunms(GraphModel graphModel) {
        ...
        if (clusteringCol == null) {
            clusteringCol = nodeTable.addColumn("clustering", "Clustering Coefficient", Double.class, null);
        }
