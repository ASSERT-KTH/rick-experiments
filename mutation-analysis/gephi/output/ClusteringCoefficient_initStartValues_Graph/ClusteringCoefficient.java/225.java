...
----> before:     private int processNetwork(ArrayWrapper[] currentNetwork, int currentProgress) {
----> after:     private int processNetwork(ArrayWrapper[] currentNetwork, int currentProgress) { currentNetwork = null;
----> line number in original file: 449
----> mutated node: 1412
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private int processNetwork(ArrayWrapper[] currentNetwork, int currentProgress) { currentNetwork = null;
