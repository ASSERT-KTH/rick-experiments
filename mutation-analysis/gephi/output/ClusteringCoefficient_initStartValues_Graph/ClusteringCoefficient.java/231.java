...
----> before:     private void tr_link_nohigh(ArrayWrapper[] currentNetwork, int[] currentTriangles, int u, int v, int count, int k) {
----> after:     private void tr_link_nohigh(ArrayWrapper[] currentNetwork, int[] currentTriangles, int u, int v, int count, int k) { currentNetwork = null;
----> line number in original file: 391
----> mutated node: 1380
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private void tr_link_nohigh(ArrayWrapper[] currentNetwork, int[] currentTriangles, int u, int v, int count, int k) { currentNetwork = null;
        int iu = 0, iv = 0, w;
