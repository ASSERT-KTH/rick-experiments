...
----> before:     private EdgeWrapper[] getEdges(HashMap<Node, EdgeWrapper> neighborTable) {
----> after:     private EdgeWrapper[] getEdges(HashMap<Node, EdgeWrapper> neighborTable) { neighborTable = null;
----> line number in original file: 438
----> mutated node: 1402
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private EdgeWrapper[] getEdges(HashMap<Node, EdgeWrapper> neighborTable) { neighborTable = null;
