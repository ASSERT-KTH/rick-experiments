...
----> before:     public void initStartValues(Graph graph) {
----> after:     public void initStartValues(Graph graph) { graph = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    public void initStartValues(Graph graph) { graph = null;
