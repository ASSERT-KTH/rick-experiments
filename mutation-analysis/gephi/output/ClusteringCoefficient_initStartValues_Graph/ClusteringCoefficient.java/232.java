...
----> before:     private void newVertex(ArrayWrapper[] currentNetwork, int[] currentTrianlgles, int v, int n) {
----> after:     private void newVertex(ArrayWrapper[] currentNetwork, int[] currentTrianlgles, int v, int n) { currentNetwork = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
     ...
     */
    private void newVertex(ArrayWrapper[] currentNetwork, int[] currentTrianlgles, int v, int n) { currentNetwork = null;
        int[] A = new int[n];
