...
----> before:                                                         boolean directed, int currentProgress) {
----> after:                                                         boolean directed, int currentProgress) { currentNetwork = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private HashMap<String, Double> computeResultValues(Graph graph, ArrayWrapper[] currentNetwork,
                                                        ...
                                                        boolean directed, int currentProgress) { currentNetwork = null;
        int n = graph.getNodeCount();
