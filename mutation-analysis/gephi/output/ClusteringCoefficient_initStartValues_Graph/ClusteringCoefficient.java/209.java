...
----> before:     public void setProgressTicket(ProgressTicket ProgressTicket) {
----> after:     public void setProgressTicket(ProgressTicket ProgressTicket) { ProgressTicket = null;
----> line number in original file: 764
----> mutated node: 1564
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    @Override
    public void setProgressTicket(ProgressTicket ProgressTicket) { ProgressTicket = null;
