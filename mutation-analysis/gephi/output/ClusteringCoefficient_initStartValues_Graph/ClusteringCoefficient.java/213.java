...
----> after:     private float computeNodeClusteringCoefficient(Graph graph, Node node, boolean directed) { node = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private float computeNodeClusteringCoefficient(Graph graph, Node node, boolean directed) { node = null;
        float nodeCC = 0;
        int neighborhood = 0;
