...
----> before:     public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) {
----> after:     public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) { sourceColor = null;
...
public class EdgeColor {
    ...
    public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) { sourceColor = null;
        switch (mode) {
            case ORIGINAL:
