...
----> after:     public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) { targetColor = null;
...
public class EdgeColor {
    ...
    public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) { targetColor = null;
        switch (mode) {
            case ORIGINAL:
