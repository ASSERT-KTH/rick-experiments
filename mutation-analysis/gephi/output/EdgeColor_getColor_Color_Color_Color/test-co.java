...
public class TestEdgeColorRickGen {
    ...
    public void test_getColor_PO_0fdd2586263f4a01939a6792f6c26498() throws Exception {
        ...
        Mockito.lenient().when(mockColor.getRed()).thenReturn(0);
        Mockito.lenient().when(mockColor.getGreen()).thenReturn(0);
        Mockito.lenient().when(mockColor.getBlue()).thenReturn(0);
        Mockito.lenient().when(mockColor.getAlpha()).thenReturn(255);
        // Act
