...
----> before:                 Math.min(maxJT, estimatedOptimalJitterTolerance * totalEffectiveTraction / Math.pow(nodes.length, 2)));
----> after:                 Math.min(maxJT, estimatedOptimalJitterTolerance * totalEffectiveTraction * Math.pow(nodes.length, 2)));
