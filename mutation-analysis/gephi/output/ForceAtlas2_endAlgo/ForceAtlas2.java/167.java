...
----> before:     public void setAdjustSizes(Boolean adjustSizes) {
----> after:     public void setAdjustSizes(Boolean adjustSizes) { adjustSizes = null;
...
public class ForceAtlas2 implements Layout {
    ...
    public void setAdjustSizes(Boolean adjustSizes) { adjustSizes = null;
