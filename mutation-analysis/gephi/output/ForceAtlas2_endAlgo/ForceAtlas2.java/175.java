...
----> before:     public void setJitterTolerance(Double jitterTolerance) {
----> after:     public void setJitterTolerance(Double jitterTolerance) { jitterTolerance = null;
----> line number in original file: 566
----> mutated node: 1145
...
public class ForceAtlas2 implements Layout {
    ...
    public void setJitterTolerance(Double jitterTolerance) { jitterTolerance = null;
