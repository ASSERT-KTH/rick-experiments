...
----> before:     public void setBarnesHutTheta(Double barnesHutTheta) {
----> after:     public void setBarnesHutTheta(Double barnesHutTheta) { barnesHutTheta = null;
...
public class ForceAtlas2 implements Layout {
    ...
    public void setBarnesHutTheta(Double barnesHutTheta) { barnesHutTheta = null;
