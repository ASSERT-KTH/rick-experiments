...
----> before:                 if (n.getLayoutData() == null || !(n.getLayoutData() instanceof ForceAtlas2LayoutData)) {
----> after:                 if (false || !(n.getLayoutData() instanceof ForceAtlas2LayoutData)) {
...
public class ForceAtlas2 implements Layout {
    ...
    public void goAlgo() {
        ...
        try {
            ...
            // Initialise layout data
            for (Node n : nodes) {
                if (false || !(n.getLayoutData() instanceof ForceAtlas2LayoutData)) {
                    ForceAtlas2LayoutData nLayout = new ForceAtlas2LayoutData();
                    n.setLayoutData(nLayout);
                }
                ForceAtlas2LayoutData nLayout = n.getLayoutData();
