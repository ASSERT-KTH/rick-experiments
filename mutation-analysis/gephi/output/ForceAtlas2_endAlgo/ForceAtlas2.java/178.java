...
----> before:     public void setGraphModel(GraphModel graphModel) {
----> after:     public void setGraphModel(GraphModel graphModel) { graphModel = null;
...
public class ForceAtlas2 implements Layout {
    ...
    @Override
    public void setGraphModel(GraphModel graphModel) { graphModel = null;
