...
----> before:     public int compare(EdgeWrapper o1, EdgeWrapper o2) {
----> after:     public int compare(EdgeWrapper o1, EdgeWrapper o2) { o2 = null;
...
class Renumbering implements Comparator<EdgeWrapper> {
    ...
    @Override
    public int compare(EdgeWrapper o1, EdgeWrapper o2) { o2 = null;
