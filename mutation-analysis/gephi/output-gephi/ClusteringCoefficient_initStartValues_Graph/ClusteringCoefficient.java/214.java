...
----> before:     private float computeNodeClusteringCoefficient(Graph graph, Node node, boolean directed) {
----> after:     private float computeNodeClusteringCoefficient(Graph graph, Node node, boolean directed) { graph = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private float computeNodeClusteringCoefficient(Graph graph, Node node, boolean directed) { graph = null;
        float nodeCC = 0;
        int neighborhood = 0;
