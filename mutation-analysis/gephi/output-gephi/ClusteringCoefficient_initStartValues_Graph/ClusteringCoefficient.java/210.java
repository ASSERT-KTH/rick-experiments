...
----> before:                                      double nodeClusteringCoefficient) {
----> after:                                      double nodeClusteringCoefficient) { clusteringColumn = null;
----> line number in original file: 676
----> mutated node: 1528
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private void saveCalculatedValue(Node node, Column clusteringColumn,
                                     double nodeClusteringCoefficient) { clusteringColumn = null;
