...
----> before:     public void execute(GraphModel graphModel) {
----> after:     public void execute(GraphModel graphModel) { graphModel = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    @Override
    public void execute(GraphModel graphModel) { graphModel = null;
        Graph graph;
        if (isDirected) {
