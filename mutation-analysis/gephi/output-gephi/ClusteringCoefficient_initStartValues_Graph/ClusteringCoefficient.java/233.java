...
----> before:     private int closest_in_array(ArrayWrapper[] currentNetwork, int v) {
----> after:     private int closest_in_array(ArrayWrapper[] currentNetwork, int v) { currentNetwork = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private int closest_in_array(ArrayWrapper[] currentNetwork, int v) { currentNetwork = null;
