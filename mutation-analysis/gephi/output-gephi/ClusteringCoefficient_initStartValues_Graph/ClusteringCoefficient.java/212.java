...
----> before:     private Column initializeAttributeColunms(GraphModel graphModel) {
----> after:     private Column initializeAttributeColunms(GraphModel graphModel) { graphModel = null;
----> line number in original file: 660
----> mutated node: 1516
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private Column initializeAttributeColunms(GraphModel graphModel) { graphModel = null;
