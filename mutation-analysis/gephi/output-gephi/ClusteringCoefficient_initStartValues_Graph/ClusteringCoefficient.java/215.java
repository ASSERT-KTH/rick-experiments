...
----> before:     private float increaseCCifNesessary(Graph graph, Node neighbor1, Node neighbor2, boolean directed, float nodeCC) {
----> after:     private float increaseCCifNesessary(Graph graph, Node neighbor1, Node neighbor2, boolean directed, float nodeCC) { neighbor2 = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private float increaseCCifNesessary(Graph graph, Node neighbor1, Node neighbor2, boolean directed, float nodeCC) { neighbor2 = null;
