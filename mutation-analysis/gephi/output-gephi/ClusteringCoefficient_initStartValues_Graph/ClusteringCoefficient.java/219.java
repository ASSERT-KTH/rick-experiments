...
----> before:                                                      double[] nodeClustering, boolean directed) {
----> after:                                                      double[] nodeClustering, boolean directed) { currentNetwork = null;
----> line number in original file: 518
----> mutated node: 1469
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private HashMap<String, Double> computeTriangles(Graph graph, ArrayWrapper[] currentNetwork, int[] currentTriangles,
                                                     double[] nodeClustering, boolean directed) { currentNetwork = null;
