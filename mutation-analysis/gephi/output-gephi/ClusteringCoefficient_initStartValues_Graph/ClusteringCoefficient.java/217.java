...
----> after:     private float increaseCCifNesessary(Graph graph, Node neighbor1, Node neighbor2, boolean directed, float nodeCC) { graph = null;
...
public class ClusteringCoefficient implements Statistics, LongTask {
    ...
    private float increaseCCifNesessary(Graph graph, Node neighbor1, Node neighbor2, boolean directed, float nodeCC) { graph = null;
