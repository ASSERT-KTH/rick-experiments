...
----> before:     private long getLongId(NodeDraftImpl source, NodeDraftImpl target, boolean directed) {
----> after:     private long getLongId(NodeDraftImpl source, NodeDraftImpl target, boolean directed) { source = null;
...
//
    ...
    private long getLongId(NodeDraftImpl source, NodeDraftImpl target, boolean directed) { source = null;
        if (directed) {
