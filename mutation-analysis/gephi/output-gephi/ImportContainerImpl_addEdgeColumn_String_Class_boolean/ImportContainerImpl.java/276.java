...
----> before:     public void setInterval(String startDateTime, String endDateTime) {
----> after:     public void setInterval(String startDateTime, String endDateTime) { startDateTime = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void setInterval(String startDateTime, String endDateTime) { startDateTime = null;
        try {
            double start, end;
