...
----> after:     public ColumnDraft addEdgeColumn(String key, Class typeClass, boolean dynamic) { key = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft addEdgeColumn(String key, Class typeClass, boolean dynamic) { key = null;
        key = key.toLowerCase().trim();
