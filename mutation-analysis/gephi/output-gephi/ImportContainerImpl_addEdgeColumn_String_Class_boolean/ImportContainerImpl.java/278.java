...
----> before:     public ColumnDraft getEdgeColumn(String key) {
----> after:     public ColumnDraft getEdgeColumn(String key) { key = null;
----> line number in original file: 577
----> mutated node: 2683
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft getEdgeColumn(String key) { key = null;
