...
----> after:     public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) { edgeColor = null;
...
public class EdgeColor {
    ...
    public Color getColor(Color edgeColor, Color sourceColor, Color targetColor) { edgeColor = null;
        switch (mode) {
            case ORIGINAL:
