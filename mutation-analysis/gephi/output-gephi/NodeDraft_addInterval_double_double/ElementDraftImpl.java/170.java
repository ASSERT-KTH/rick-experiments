...
----> before:     private static Object parseValue(String value, Class type) {
----> after:     private static Object parseValue(String value, Class type) { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    private static Object parseValue(String value, Class type) { value = null;
