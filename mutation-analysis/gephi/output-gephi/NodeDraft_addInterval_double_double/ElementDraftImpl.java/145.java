...
----> after:     public void setValue(String key, Object value, double start, double end) { key = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void setValue(String key, Object value, double start, double end) { key = null;
        ColumnDraft column = getColumn(key, value.getClass());
        try {
