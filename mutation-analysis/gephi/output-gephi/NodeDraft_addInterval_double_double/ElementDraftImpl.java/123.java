...
----> before:     protected void setAttributeValue(ColumnDraft column, Object value, double timestamp) throws Exception {
----> after:     protected void setAttributeValue(ColumnDraft column, Object value, double timestamp) throws Exception { column = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    protected void setAttributeValue(ColumnDraft column, Object value, double timestamp) throws Exception { column = null;
        int index = ((ColumnDraftImpl) column).getIndex();
