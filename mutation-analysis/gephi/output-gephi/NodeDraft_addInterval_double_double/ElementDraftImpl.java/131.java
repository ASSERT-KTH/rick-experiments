...
----> before:     public void parseAndSetValue(String key, String value, double start, double end) {
----> after:     public void parseAndSetValue(String key, String value, double start, double end) { value = null;
----> line number in original file: 356
----> mutated node: 1551
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value, double start, double end) { value = null;
        ColumnDraft column = getColumn(key);
