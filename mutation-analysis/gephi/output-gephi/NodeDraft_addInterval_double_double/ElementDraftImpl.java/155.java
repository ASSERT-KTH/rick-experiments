...
----> before:     public void setValue(String key, Object value) {
----> after:     public void setValue(String key, Object value) { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void setValue(String key, Object value) { value = null;
        if (value == null) {
