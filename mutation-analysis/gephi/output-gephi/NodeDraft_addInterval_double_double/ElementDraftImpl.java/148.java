...
----> after:     public void setValue(String key, Object value, String startDateTime, String endDateTime) { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void setValue(String key, Object value, String startDateTime, String endDateTime) { value = null;
        double start, end;
