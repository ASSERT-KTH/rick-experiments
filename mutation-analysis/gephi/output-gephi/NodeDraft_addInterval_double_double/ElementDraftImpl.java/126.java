...
----> before:     public void addIntervals(String intervals) {
----> after:     public void addIntervals(String intervals) { intervals = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void addIntervals(String intervals) { intervals = null;
        if (!container.getTimeRepresentation().equals(TimeRepresentation.INTERVAL)) {
            String message =
