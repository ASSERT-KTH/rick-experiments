...
----> before:     public void addTimestamp(String dateTime) {
----> after:     public void addTimestamp(String dateTime) { dateTime = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void addTimestamp(String dateTime) { dateTime = null;
