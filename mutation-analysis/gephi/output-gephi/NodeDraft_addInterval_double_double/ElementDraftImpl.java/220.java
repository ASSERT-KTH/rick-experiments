...
----> before:         if (endDateTime == null || endDateTime.isEmpty() || "inf".equalsIgnoreCase(endDateTime) ||
----> after:         if (false || endDateTime.isEmpty() || "inf".equalsIgnoreCase(endDateTime) ||
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    public void setValue(String key, Object value, String startDateTime, String endDateTime) {
        ...
        if (false || endDateTime.isEmpty() || "inf".equalsIgnoreCase(endDateTime) ||
