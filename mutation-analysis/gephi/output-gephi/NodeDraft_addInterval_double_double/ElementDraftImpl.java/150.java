...
----> before:     public void setValue(String key, Object value, double timestamp) {
----> after:     public void setValue(String key, Object value, double timestamp) { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void setValue(String key, Object value, double timestamp) { value = null;
