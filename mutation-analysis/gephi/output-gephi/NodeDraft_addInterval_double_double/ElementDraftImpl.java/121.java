...
----> before:     protected void setAttributeValue(ColumnDraft column, Object value, double start, double end) throws Exception {
----> after:     protected void setAttributeValue(ColumnDraft column, Object value, double start, double end) throws Exception { column = null;
----> line number in original file: 528
----> mutated node: 1650
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    protected void setAttributeValue(ColumnDraft column, Object value, double start, double end) throws Exception { column = null;
        int index = ((ColumnDraftImpl) column).getIndex();
        value = AttributeUtils.standardizeValue(value);
        Class typeClass = column.getTypeClass();
        if (!value.getClass().equals(typeClass)) {
