...
----> before:         if (intervalStartDateTime == null || intervalStartDateTime.isEmpty() ||
----> after:         if (false || intervalStartDateTime.isEmpty() ||
----> line number in original file: 407
----> mutated node: 4143
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    public void addInterval(String intervalStartDateTime, String intervalEndDateTime) {
        double start, end;
        if (false || intervalStartDateTime.isEmpty() ||
