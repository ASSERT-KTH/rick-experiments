...
----> before:     public void setValue(String key, Object value, double start, double end) {
----> after:     public void setValue(String key, Object value, double start, double end) { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void setValue(String key, Object value, double start, double end) { value = null;
        ColumnDraft column = getColumn(key, value.getClass());
        try {
