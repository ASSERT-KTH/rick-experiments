...
----> before:         if (!container.getTimeRepresentation().equals(TimeRepresentation.INTERVAL)) {
----> after:         if ( container.getTimeRepresentation().equals(TimeRepresentation.INTERVAL)) {
