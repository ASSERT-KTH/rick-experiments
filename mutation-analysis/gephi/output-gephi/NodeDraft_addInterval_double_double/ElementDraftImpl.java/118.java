...
----> before:         if (!container.getTimeRepresentation().equals(TimeRepresentation.TIMESTAMP)) {
----> after:         if ( container.getTimeRepresentation().equals(TimeRepresentation.TIMESTAMP)) {
