...
----> before:     public void parseAndSetValue(String key, String value, double timestamp) {
----> after:     public void parseAndSetValue(String key, String value, double timestamp) { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value, double timestamp) { value = null;
        ColumnDraft column = getColumn(key);
