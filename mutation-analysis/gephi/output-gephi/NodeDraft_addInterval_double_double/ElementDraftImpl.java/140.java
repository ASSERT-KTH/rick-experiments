...
----> after:     public void parseAndSetValue(String key, String value, String dateTime) { value = null;
...
public abstract class ElementDraftImpl implements ElementDraft {
    ...
    @Override
    public void parseAndSetValue(String key, String value, String dateTime) { value = null;
