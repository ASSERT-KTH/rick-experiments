...
----> before:             float scale = -relativeStrength * optimalDistance * optimalDistance / (distance * distance);
----> after:             float scale = -relativeStrength * optimalDistance * optimalDistance * (distance * distance);
----> line number in original file: 488
----> mutated node: 3183
