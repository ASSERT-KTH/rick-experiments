...
----> before:     protected void mergeDirectedEdges(EdgeDraftImpl source, EdgeDraftImpl dest) {
----> after:     protected void mergeDirectedEdges(EdgeDraftImpl source, EdgeDraftImpl dest) { source = null;
----> line number in original file: 896
----> mutated node: 2768
...
//
    ...
    protected void mergeDirectedEdges(EdgeDraftImpl source, EdgeDraftImpl dest) { source = null;
