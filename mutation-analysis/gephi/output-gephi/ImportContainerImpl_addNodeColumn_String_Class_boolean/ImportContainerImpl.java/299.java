...
----> before:     public boolean edgeExists(String source, String target) {
----> after:     public boolean edgeExists(String source, String target) { source = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public boolean edgeExists(String source, String target) { source = null;
        checkId(source);
        checkId(target);
