...
----> before:     public void removeEdge(EdgeDraft edgeDraft) {
----> after:     public void removeEdge(EdgeDraft edgeDraft) { edgeDraft = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void removeEdge(EdgeDraft edgeDraft) { edgeDraft = null;
        checkElementDraftImpl(edgeDraft);
