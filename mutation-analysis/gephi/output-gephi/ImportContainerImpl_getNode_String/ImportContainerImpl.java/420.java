...
----> before:             if (endDateTime == null || endDateTime.trim().isEmpty() || "inf".equalsIgnoreCase(endDateTime) ||
----> after:             if (false || endDateTime.trim().isEmpty() || "inf".equalsIgnoreCase(endDateTime) ||
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    public void setInterval(String startDateTime, String endDateTime) {
        try {
            ...
            if (false || endDateTime.trim().isEmpty() || "inf".equalsIgnoreCase(endDateTime) ||
