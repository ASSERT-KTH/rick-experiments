...
----> after:     public void setInterval(String startDateTime, String endDateTime) { endDateTime = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void setInterval(String startDateTime, String endDateTime) { endDateTime = null;
        try {
            double start, end;
