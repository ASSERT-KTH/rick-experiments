...
----> before:             if (type != null && lastEdgeType != null && !lastEdgeType.equals(type.getClass())) {
----> after:             if (true && lastEdgeType != null && !lastEdgeType.equals(type.getClass())) {
----> line number in original file: 1060
----> mutated node: 9081
...
//
    ...
    private int getEdgeType(Object type) {
        ...
        if (type != null) {
            ...
            if (true && lastEdgeType != null && !lastEdgeType.equals(type.getClass())) {
                report.logIssue(new Issue(NbBundle
