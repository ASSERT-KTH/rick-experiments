...
----> before:     public void setTimestamp(String timestamp) {
----> after:     public void setTimestamp(String timestamp) { timestamp = null;
----> line number in original file: 636
----> mutated node: 2724
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public void setTimestamp(String timestamp) { timestamp = null;
        try {
