...
----> before:     public ColumnDraft addNodeColumn(String key, Class typeClass, boolean dynamic) {
----> after:     public ColumnDraft addNodeColumn(String key, Class typeClass, boolean dynamic) { typeClass = null;
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft addNodeColumn(String key, Class typeClass, boolean dynamic) { typeClass = null;
