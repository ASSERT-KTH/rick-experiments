...
----> before:     public ColumnDraft addEdgeColumn(String key, Class typeClass) {
----> after:     public ColumnDraft addEdgeColumn(String key, Class typeClass) { typeClass = null;
----> line number in original file: 529
----> mutated node: 2651
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft addEdgeColumn(String key, Class typeClass) { typeClass = null;
        if (AttributeUtils.isDynamicType(typeClass)) {
            if (TimeSet.class.isAssignableFrom(typeClass)) {
