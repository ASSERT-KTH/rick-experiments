...
----> before:     public ColumnDraft addNodeColumn(String key, Class typeClass) {
----> after:     public ColumnDraft addNodeColumn(String key, Class typeClass) { typeClass = null;
----> line number in original file: 491
----> mutated node: 2629
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft addNodeColumn(String key, Class typeClass) { typeClass = null;
