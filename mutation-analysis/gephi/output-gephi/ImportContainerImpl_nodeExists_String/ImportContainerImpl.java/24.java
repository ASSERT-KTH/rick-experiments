...
----> before:         if (directedEdgesCount > 0 && edgeDefault.equals(EdgeDirectionDefault.UNDIRECTED)) {
----> after:         if (directedEdgesCount > 0 || edgeDefault.equals(EdgeDirectionDefault.UNDIRECTED)) {
----> line number in original file: 809
----> mutated node: 4522
