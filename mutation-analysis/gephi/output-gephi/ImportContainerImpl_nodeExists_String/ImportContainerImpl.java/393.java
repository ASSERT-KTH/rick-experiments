...
----> before:             edgeId = edgeId | (long) (Math.min(source.getSequentialId(), target.getSequentialId()));
----> after:             edgeId = edgeId ^ (long) (Math.min(source.getSequentialId(), target.getSequentialId()));
----> line number in original file: 1102
----> mutated node: 8475
