...
----> before:     private void checkElementDraftImpl(ElementDraft elmt) {
----> after:     private void checkElementDraftImpl(ElementDraft elmt) { elmt = null;
----> line number in original file: 1136
----> mutated node: 2929
...
//
    ...
    private void checkElementDraftImpl(ElementDraft elmt) { elmt = null;
        if (elmt == null) {
