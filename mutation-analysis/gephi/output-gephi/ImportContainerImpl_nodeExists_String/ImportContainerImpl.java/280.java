...
----> before:     public ColumnDraft getNodeColumn(String key) {
----> after:     public ColumnDraft getNodeColumn(String key) { key = null;
----> line number in original file: 567
----> mutated node: 2671
...
public class ImportContainerImpl implements Container, ContainerLoader, ContainerUnloader {
    ...
    @Override
    public ColumnDraft getNodeColumn(String key) { key = null;
