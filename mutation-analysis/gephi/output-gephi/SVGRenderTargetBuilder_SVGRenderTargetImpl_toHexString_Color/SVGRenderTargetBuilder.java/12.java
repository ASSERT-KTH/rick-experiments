...
----> before:     public RenderTarget buildRenderTarget(PreviewModel previewModel) {
----> after:     public RenderTarget buildRenderTarget(PreviewModel previewModel) { previewModel = null;
...
public class SVGRenderTargetBuilder implements RenderTargetBuilder {
    ...
    @Override
    public RenderTarget buildRenderTarget(PreviewModel previewModel) { previewModel = null;
