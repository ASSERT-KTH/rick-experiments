...
----> before:         public Element getTopElement(String name) {
----> after:         public Element getTopElement(String name) { name = null;
...
public class SVGRenderTargetBuilder implements RenderTargetBuilder {
    ...
    public static class SVGRenderTargetImpl
        ...
        @Override
        public Element getTopElement(String name) { name = null;
