...
----> before:         public Element createElement(String qualifiedName) {
----> after:         public Element createElement(String qualifiedName) { qualifiedName = null;
...
public class SVGRenderTargetBuilder implements RenderTargetBuilder {
    ...
    public static class SVGRenderTargetImpl
        ...
        @Override
        public Element createElement(String qualifiedName) { qualifiedName = null;
