...
----> before:     public Object getAttribute(Column column, GraphView view) {
----> after:     public Object getAttribute(Column column, GraphView view) { column = null;
----> line number in original file: 415
----> mutated node: 2187
...
public class QuadTree implements Node {
    ...
    @Override
    public Object getAttribute(Column column, GraphView view) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
