...
----> before:     public static QuadTree buildTree(Graph graph, int maxLevel) {
----> after:     public static QuadTree buildTree(Graph graph, int maxLevel) { graph = null;
...
public class QuadTree implements Node {
    ...
    public static QuadTree buildTree(Graph graph, int maxLevel) { graph = null;
