...
----> before:     public Object getAttribute(String key, double timestamp) {
----> after:     public Object getAttribute(String key, double timestamp) { key = null;
----> line number in original file: 400
----> mutated node: 2163
...
public class QuadTree implements Node {
    ...
    @Override
    public Object getAttribute(String key, double timestamp) { key = null;
        throw new UnsupportedOperationException("Not supported.");
    }
