...
----> after:     public void setAttribute(String key, Object value, Interval interval) { value = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(String key, Object value, Interval interval) { value = null;
        throw new UnsupportedOperationException("Not supported.");
    }
