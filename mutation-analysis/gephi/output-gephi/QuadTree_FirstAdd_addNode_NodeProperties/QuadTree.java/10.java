...
----> after:     public void setAttribute(Column column, Object value, Interval interval) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(Column column, Object value, Interval interval) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
