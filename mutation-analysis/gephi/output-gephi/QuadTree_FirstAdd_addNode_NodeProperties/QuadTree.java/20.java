...
----> before:     public Iterable<Map.Entry> getAttributes(Column column) {
----> after:     public Iterable<Map.Entry> getAttributes(Column column) { column = null;
----> line number in original file: 435
----> mutated node: 2216
...
public class QuadTree implements Node {
    ...
    @Override
    public Iterable<Map.Entry> getAttributes(Column column) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
