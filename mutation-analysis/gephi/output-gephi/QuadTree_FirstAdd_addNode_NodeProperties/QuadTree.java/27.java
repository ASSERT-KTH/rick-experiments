...
----> before:     public Object getAttribute(String key, GraphView view) {
----> after:     public Object getAttribute(String key, GraphView view) { view = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object getAttribute(String key, GraphView view) { view = null;
        throw new UnsupportedOperationException("Not supported.");
    }
