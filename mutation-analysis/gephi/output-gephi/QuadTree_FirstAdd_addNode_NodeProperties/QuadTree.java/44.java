...
----> before:     public void setLayoutData(LayoutData layoutData) {
----> after:     public void setLayoutData(LayoutData layoutData) { layoutData = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setLayoutData(LayoutData layoutData) { layoutData = null;
        throw new UnsupportedOperationException("Not supported.");
    }
