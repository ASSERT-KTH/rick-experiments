...
----> before:     public void setAttribute(Column column, Object value) {
----> after:     public void setAttribute(Column column, Object value) { column = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public void setAttribute(Column column, Object value) { column = null;
        throw new UnsupportedOperationException("Not supported.");
    }
