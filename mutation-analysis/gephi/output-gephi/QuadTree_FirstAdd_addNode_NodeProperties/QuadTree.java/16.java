...
----> before:     public Object removeAttribute(String key, Interval interval) {
----> after:     public Object removeAttribute(String key, Interval interval) { interval = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object removeAttribute(String key, Interval interval) { interval = null;
