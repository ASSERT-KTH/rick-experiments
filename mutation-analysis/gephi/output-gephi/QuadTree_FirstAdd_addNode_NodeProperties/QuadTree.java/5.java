...
----> before:     public boolean hasInterval(Interval interval) {
----> after:     public boolean hasInterval(Interval interval) { interval = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public boolean hasInterval(Interval interval) { interval = null;
        throw new UnsupportedOperationException("Not supported.");
    }
