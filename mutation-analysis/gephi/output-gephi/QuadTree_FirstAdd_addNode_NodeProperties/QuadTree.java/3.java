...
----> before:         public boolean addNode(NodeProperties node) {
----> after:         public boolean addNode(NodeProperties node) { node = null;
...
public class QuadTree implements Node {
    ...
    class SecondAdd implements AddBehaviour {
        ...
        @Override
        public boolean addNode(NodeProperties node) { node = null;
            divideTree();
            add = new RootAdd();
