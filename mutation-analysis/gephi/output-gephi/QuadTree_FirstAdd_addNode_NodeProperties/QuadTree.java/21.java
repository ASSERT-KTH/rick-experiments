...
----> before:     public Object getAttribute(Column column, Interval interval) {
----> after:     public Object getAttribute(Column column, Interval interval) { interval = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public Object getAttribute(Column column, Interval interval) { interval = null;
        throw new UnsupportedOperationException("Not supported.");
    }
