...
----> before:     public boolean removeInterval(Interval interval) {
----> after:     public boolean removeInterval(Interval interval) { interval = null;
...
public class QuadTree implements Node {
    ...
    @Override
    public boolean removeInterval(Interval interval) { interval = null;
        throw new UnsupportedOperationException("Not supported.");
    }
