...
----> after:     public void postProcess(PreviewModel previewModel, RenderTarget renderTarget, PreviewProperties properties) { properties = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public void postProcess(PreviewModel previewModel, RenderTarget renderTarget, PreviewProperties properties) { properties = null;
    }
