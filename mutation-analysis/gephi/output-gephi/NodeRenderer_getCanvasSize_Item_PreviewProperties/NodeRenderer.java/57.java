...
----> before:     public boolean needsItemBuilder(ItemBuilder itemBuilder, PreviewProperties properties) {
----> after:     public boolean needsItemBuilder(ItemBuilder itemBuilder, PreviewProperties properties) { itemBuilder = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public boolean needsItemBuilder(ItemBuilder itemBuilder, PreviewProperties properties) { itemBuilder = null;
