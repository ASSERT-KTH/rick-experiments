...
----> before:     public void render(Item item, RenderTarget target, PreviewProperties properties) {
----> after:     public void render(Item item, RenderTarget target, PreviewProperties properties) { properties = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public void render(Item item, RenderTarget target, PreviewProperties properties) { properties = null;
