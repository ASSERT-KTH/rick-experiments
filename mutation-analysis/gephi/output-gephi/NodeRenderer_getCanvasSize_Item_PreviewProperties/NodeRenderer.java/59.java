...
----> after:     public boolean isRendererForitem(Item item, PreviewProperties properties) { item = null;
...
public class NodeRenderer implements Renderer {
    ...
    @Override
    public boolean isRendererForitem(Item item, PreviewProperties properties) { item = null;
