...
----> before:     protected DependantColor defaultBorderColor = new DependantColor(Color.BLACK);
----> after:     protected DependantColor defaultBorderColor = null;
...
public class NodeRenderer implements Renderer {
    ...
    protected DependantColor defaultBorderColor = null;
