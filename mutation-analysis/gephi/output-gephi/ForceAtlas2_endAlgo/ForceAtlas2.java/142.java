...
----> before:                         Math.sqrt(Math.pow(nLayout.old_dx - nLayout.dx, 2) + Math.pow(nLayout.old_dy - nLayout.dy, 2));
----> after:                         Math.sqrt(Math.pow(nLayout.old_dx - nLayout.dx, 2) - Math.pow(nLayout.old_dy - nLayout.dy, 2));
