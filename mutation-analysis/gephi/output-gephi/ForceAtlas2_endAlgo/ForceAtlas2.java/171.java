...
----> before:     public void setStrongGravityMode(Boolean strongGravityMode) {
----> after:     public void setStrongGravityMode(Boolean strongGravityMode) { strongGravityMode = null;
----> line number in original file: 598
----> mutated node: 1177
...
public class ForceAtlas2 implements Layout {
    ...
    public void setStrongGravityMode(Boolean strongGravityMode) { strongGravityMode = null;
