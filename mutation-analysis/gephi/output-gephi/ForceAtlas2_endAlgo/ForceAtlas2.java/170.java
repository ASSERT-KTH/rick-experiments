...
----> before:     public void setGravity(Double gravity) {
----> after:     public void setGravity(Double gravity) { gravity = null;
----> line number in original file: 606
----> mutated node: 1185
...
public class ForceAtlas2 implements Layout {
    ...
    public void setGravity(Double gravity) { gravity = null;
