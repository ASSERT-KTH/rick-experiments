...
----> before:     public void setScalingRatio(Double scalingRatio) {
----> after:     public void setScalingRatio(Double scalingRatio) { scalingRatio = null;
...
public class ForceAtlas2 implements Layout {
    ...
    public void setScalingRatio(Double scalingRatio) { scalingRatio = null;
