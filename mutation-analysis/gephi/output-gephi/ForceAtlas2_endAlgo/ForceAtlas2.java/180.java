...
----> after:     private double getEdgeWeight(Edge edge, boolean isDynamicWeight, Interval interval) { edge = null;
...
public class ForceAtlas2 implements Layout {
    ...
    private double getEdgeWeight(Edge edge, boolean isDynamicWeight, Interval interval) { edge = null;
        if (isDynamicWeight) {
