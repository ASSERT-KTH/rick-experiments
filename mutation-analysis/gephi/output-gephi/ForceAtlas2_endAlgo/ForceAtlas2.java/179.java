...
----> before:     private double getEdgeWeight(Edge edge, boolean isDynamicWeight, Interval interval) {
----> after:     private double getEdgeWeight(Edge edge, boolean isDynamicWeight, Interval interval) { interval = null;
...
public class ForceAtlas2 implements Layout {
    ...
    private double getEdgeWeight(Edge edge, boolean isDynamicWeight, Interval interval) { interval = null;
        if (isDynamicWeight) {
