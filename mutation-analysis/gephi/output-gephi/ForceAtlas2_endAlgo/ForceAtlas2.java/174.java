...
----> before:     public void setLinLogMode(Boolean linLogMode) {
----> after:     public void setLinLogMode(Boolean linLogMode) { linLogMode = null;
...
public class ForceAtlas2 implements Layout {
    ...
    public void setLinLogMode(Boolean linLogMode) { linLogMode = null;
