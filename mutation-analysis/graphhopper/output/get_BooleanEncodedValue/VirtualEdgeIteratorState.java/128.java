...
----> before:     public int get(IntEncodedValue property) {
----> after:     public int get(IntEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public int get(IntEncodedValue property) { property = null;
