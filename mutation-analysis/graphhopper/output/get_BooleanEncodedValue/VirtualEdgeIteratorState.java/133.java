...
----> before:     public boolean get(BooleanEncodedValue property) {
----> after:     public boolean get(BooleanEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public boolean get(BooleanEncodedValue property) { property = null;
