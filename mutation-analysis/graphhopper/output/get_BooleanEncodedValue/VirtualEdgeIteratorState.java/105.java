...
----> before:     public EdgeIteratorState setReverse(StringEncodedValue property, String value) {
----> after:     public EdgeIteratorState setReverse(StringEncodedValue property, String value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState setReverse(StringEncodedValue property, String value) { property = null;
        property.setString(!reverse, edgeFlags, value);
        return this;
    }
