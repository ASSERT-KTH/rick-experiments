...
----> before:     public EdgeIteratorState setName(String name) {
----> after:     public EdgeIteratorState setName(String name) { name = null;
----> line number in original file: 309
----> mutated node: 1459
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState setName(String name) { name = null;
        this.name = name;
        return this;
    }
