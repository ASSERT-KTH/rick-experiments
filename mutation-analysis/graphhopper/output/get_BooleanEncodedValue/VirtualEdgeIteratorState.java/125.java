...
----> before:     public EdgeIteratorState setReverse(IntEncodedValue property, int value) {
----> after:     public EdgeIteratorState setReverse(IntEncodedValue property, int value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState setReverse(IntEncodedValue property, int value) { property = null;
        property.setInt(!reverse, edgeFlags, value);
        return this;
    }
