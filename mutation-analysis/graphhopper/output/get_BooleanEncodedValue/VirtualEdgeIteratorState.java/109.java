...
----> before:     public String get(StringEncodedValue property) {
----> after:     public String get(StringEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public String get(StringEncodedValue property) { property = null;
