...
----> before:     public EdgeIteratorState set(StringEncodedValue property, String value) {
----> after:     public EdgeIteratorState set(StringEncodedValue property, String value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(StringEncodedValue property, String value) { property = null;
