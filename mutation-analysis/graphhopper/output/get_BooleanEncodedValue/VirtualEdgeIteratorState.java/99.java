...
----> before:     public EdgeIteratorState copyPropertiesFrom(EdgeIteratorState fromEdge) {
----> after:     public EdgeIteratorState copyPropertiesFrom(EdgeIteratorState fromEdge) { fromEdge = null;
----> line number in original file: 351
----> mutated node: 1491
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState copyPropertiesFrom(EdgeIteratorState fromEdge) { fromEdge = null;
