...
----> before:     public String getReverse(StringEncodedValue property) {
----> after:     public String getReverse(StringEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public String getReverse(StringEncodedValue property) { property = null;
        return property.getString(!reverse, edgeFlags);
    }
