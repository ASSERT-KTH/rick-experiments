...
----> before:     public PointList fetchWayGeometry(FetchMode mode) {
----> after:     public PointList fetchWayGeometry(FetchMode mode) { mode = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public PointList fetchWayGeometry(FetchMode mode) { mode = null;
        if (pointList.size() == 0)
