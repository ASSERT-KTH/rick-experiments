...
----> before:     public EdgeIteratorState set(DecimalEncodedValue property, double fwd, double bwd) {
----> after:     public EdgeIteratorState set(DecimalEncodedValue property, double fwd, double bwd) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(DecimalEncodedValue property, double fwd, double bwd) { property = null;
        if (!property.isStoreTwoDirections())
            throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
