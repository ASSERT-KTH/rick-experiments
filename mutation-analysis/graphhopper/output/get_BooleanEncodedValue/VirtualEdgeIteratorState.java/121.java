...
----> before:     public double getReverse(DecimalEncodedValue property) {
----> after:     public double getReverse(DecimalEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public double getReverse(DecimalEncodedValue property) { property = null;
        return property.getDecimal(!reverse, edgeFlags);
    }
