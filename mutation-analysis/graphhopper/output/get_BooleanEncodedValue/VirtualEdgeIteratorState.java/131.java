...
----> before:     public boolean getReverse(BooleanEncodedValue property) {
----> after:     public boolean getReverse(BooleanEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public boolean getReverse(BooleanEncodedValue property) { property = null;
        if (property == EdgeIteratorState.UNFAVORED_EDGE)
            return unfavored;
        return property.getBool(!reverse, edgeFlags);
    }
