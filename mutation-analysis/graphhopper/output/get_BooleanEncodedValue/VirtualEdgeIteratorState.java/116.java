...
----> after:     public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T value) { value = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T value) { value = null;
