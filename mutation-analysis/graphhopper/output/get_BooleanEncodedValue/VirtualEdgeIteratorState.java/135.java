...
----> before:     public EdgeIteratorState setWayGeometry(PointList list) {
----> after:     public EdgeIteratorState setWayGeometry(PointList list) { list = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState setWayGeometry(PointList list) { list = null;
