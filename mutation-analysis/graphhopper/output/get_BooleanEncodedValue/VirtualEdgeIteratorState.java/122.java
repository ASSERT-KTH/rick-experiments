...
----> before:     public EdgeIteratorState set(DecimalEncodedValue property, double value) {
----> after:     public EdgeIteratorState set(DecimalEncodedValue property, double value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(DecimalEncodedValue property, double value) { property = null;
