...
----> before:     public String getTurnDescription(Translation tr) {
----> after:     public String getTurnDescription(Translation tr) { tr = null;
...
public class RoundaboutInstruction extends Instruction {
    ...
    @Override
    public String getTurnDescription(Translation tr) { tr = null;
        if (rawName)
            return getName();
