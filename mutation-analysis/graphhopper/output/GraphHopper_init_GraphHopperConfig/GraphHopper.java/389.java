...
----> before:     private void setCHProfileVersion(String profile, int version) {
----> after:     private void setCHProfileVersion(String profile, int version) { profile = null;
----> line number in original file: 1014
----> mutated node: 2865
...
public class GraphHopper {
    ...
    private void setCHProfileVersion(String profile, int version) { profile = null;
