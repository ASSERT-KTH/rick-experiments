...
----> before:     public GraphHopper setOSMFile(String osmFile) {
----> after:     public GraphHopper setOSMFile(String osmFile) { osmFile = null;
...
public class GraphHopper {
     ...
     * (.pbf).
     */
    public GraphHopper setOSMFile(String osmFile) { osmFile = null;
        ensureNotLoaded();
        if (isEmpty(osmFile))
