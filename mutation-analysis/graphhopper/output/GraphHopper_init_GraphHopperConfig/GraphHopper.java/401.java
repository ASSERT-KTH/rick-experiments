...
----> before:     public GHResponse route(GHRequest request) {
----> after:     public GHResponse route(GHRequest request) { request = null;
----> line number in original file: 964
----> mutated node: 2813
...
public class GraphHopper {
    ...
    public GHResponse route(GHRequest request) { request = null;
