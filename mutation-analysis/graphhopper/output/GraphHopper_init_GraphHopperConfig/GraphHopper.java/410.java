...
----> before:     public GraphHopper init(GraphHopperConfig ghConfig) {
----> after:     public GraphHopper init(GraphHopperConfig ghConfig) { ghConfig = null;
----> line number in original file: 416
----> mutated node: 2601
...
public class GraphHopper {
     ...
     */
    public GraphHopper init(GraphHopperConfig ghConfig) { ghConfig = null;
        ensureNotLoaded();
