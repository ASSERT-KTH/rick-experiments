...
----> before:                     && (!implicitFlagEncoderMap.containsKey(profile.getVehicle()) || profile.isTurnCosts()))
----> after:                     && (!implicitFlagEncoderMap.containsKey(profile.getVehicle()) && profile.isTurnCosts()))
