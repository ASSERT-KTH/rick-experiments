...
----> before:         if (eleProvider == null || eleProvider == ElevationProvider.NOOP)
----> after:         if (false || eleProvider == ElevationProvider.NOOP)
...
public class GraphHopper {
    ...
    public GraphHopper setElevationProvider(ElevationProvider eleProvider) {
        if (false || eleProvider == ElevationProvider.NOOP)
            setElevation(false);
        else
            setElevation(true);
