...
----> before:         ghStorage.getProperties().put("datareader.import.date", f.format(new Date()));
----> after:         ghStorage.getProperties().put("datareader.import.date", f.format(null));
----> line number in original file: 700
----> mutated node: 10066
...
public class GraphHopper {
    ...
    protected void importOSM() {
        ...
        ghStorage.getProperties().put("datareader.import.date", f.format(null));
