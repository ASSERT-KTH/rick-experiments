...
----> before:                     throw new RuntimeException("To avoid reading partial data we need to obtain the read lock but it failed. In " + ghLocation, lock.getObtainFailedReason());
----> after:                     throw null;
----> line number in original file: 787
----> mutated node: 12547
