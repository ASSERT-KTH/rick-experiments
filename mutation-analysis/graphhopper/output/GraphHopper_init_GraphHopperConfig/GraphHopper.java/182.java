...
----> before:     private final Map<String, Profile> profilesByName = new LinkedHashMap<>();
----> after:     private final Map<String, Profile> profilesByName = null;
...
public class GraphHopper {
    ...
    private final Map<String, Profile> profilesByName = null;
