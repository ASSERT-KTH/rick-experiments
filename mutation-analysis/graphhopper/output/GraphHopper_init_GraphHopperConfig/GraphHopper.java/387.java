...
----> before:     private void setLMProfileVersion(String profile, int version) {
----> after:     private void setLMProfileVersion(String profile, int version) { profile = null;
----> line number in original file: 1022
----> mutated node: 2876
...
public class GraphHopper {
    ...
    private void setLMProfileVersion(String profile, int version) { profile = null;
