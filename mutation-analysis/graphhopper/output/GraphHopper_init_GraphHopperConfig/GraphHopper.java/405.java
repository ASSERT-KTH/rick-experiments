...
----> before:     public final Weighting createWeighting(Profile profile, PMap hints) {
----> after:     public final Weighting createWeighting(Profile profile, PMap hints) { profile = null;
...
public class GraphHopper {
    ...
    public final Weighting createWeighting(Profile profile, PMap hints) { profile = null;
