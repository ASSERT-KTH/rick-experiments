...
----> before:         OSMReader reader = new OSMReader(ghStorage, osmReaderConfig).setFile(_getOSMFile()).
----> after:         OSMReader reader = null.setFile(_getOSMFile()).
----> line number in original file: 689
----> mutated node: 14359
...
public class GraphHopper {
    ...
    protected void importOSM() {
        ...
        OSMReader reader = null.setFile(_getOSMFile()).
