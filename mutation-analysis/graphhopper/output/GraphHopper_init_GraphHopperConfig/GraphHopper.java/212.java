...
----> before:             if (lmProfile.usesOtherPreparation() && !profilesByName.containsKey(lmProfile.getPreparationProfile())) {
----> after:             if (lmProfile.usesOtherPreparation() || !profilesByName.containsKey(lmProfile.getPreparationProfile())) {
