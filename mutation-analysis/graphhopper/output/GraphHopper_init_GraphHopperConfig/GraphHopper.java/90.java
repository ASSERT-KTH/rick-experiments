...
----> before:                 chConfigs.add(CHConfig.nodeBased(profile.getName(), createWeighting(profile, new PMap())));
----> after:                 chConfigs.add(CHConfig.nodeBased(profile.getName(), createWeighting(profile, null)));
----> line number in original file: 877
----> mutated node: 15210
    ...
    private List<CHConfig> createCHConfigs(List<CHProfile> chProfiles) {
        ...
        for (CHProfile chProfile : chProfiles) {
            ...
            if (profile.isTurnCosts()) {
                ...
                chConfigs.add(CHConfig.nodeBased(profile.getName(), createWeighting(profile, null)));
            }
        }
        return chConfigs;
    }
