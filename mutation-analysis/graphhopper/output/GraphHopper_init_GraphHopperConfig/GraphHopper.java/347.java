...
----> before:         List<LMConfig> configsToPrepare = lmConfigs.stream().filter(c -> !loadedConfigs.contains(c)).collect(Collectors.toList());
----> after:         List<LMConfig> configsToPrepare = lmConfigs.stream().filter(c ->  loadedConfigs.contains(c)).collect(Collectors.toList());
----> line number in original file: 1074
----> mutated node: 13816
