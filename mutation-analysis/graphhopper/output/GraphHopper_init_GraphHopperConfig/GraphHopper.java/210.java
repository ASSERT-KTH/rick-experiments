...
----> before:             if (lmProfile.usesOtherPreparation() && lmProfileMap.get(lmProfile.getPreparationProfile()).usesOtherPreparation()) {
----> after:             if (lmProfile.usesOtherPreparation() || lmProfileMap.get(lmProfile.getPreparationProfile()).usesOtherPreparation()) {
