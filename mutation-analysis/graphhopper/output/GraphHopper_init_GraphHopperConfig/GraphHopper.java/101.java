...
----> before:         Set<String> chProfileSet = new LinkedHashSet<>(chPreparationHandler.getCHProfiles().size());
----> after:         Set<String> chProfileSet = null;
----> line number in original file: 833
----> mutated node: 9256
