...
----> before:         if (osmReaderConfig.getLongEdgeSamplingDistance() < Double.MAX_VALUE && !elevationProvider.canInterpolate())
----> after:         if (osmReaderConfig.getLongEdgeSamplingDistance() < Double.MAX_VALUE &&  elevationProvider.canInterpolate())
