...
----> before:                 implicitFlagEncoderMap.put(profile.getVehicle(), profile.getVehicle() + (profile.isTurnCosts() ? "|turn_costs=true" : ""));
----> after:                 implicitFlagEncoderMap.put(profile.getVehicle(), profile.getVehicle() - (profile.isTurnCosts() ? "|turn_costs=true" : ""));
