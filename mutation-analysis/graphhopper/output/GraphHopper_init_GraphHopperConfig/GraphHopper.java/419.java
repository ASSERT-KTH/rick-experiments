...
----> before:     public GraphHopper setGraphHopperLocation(String ghLocation) {
----> after:     public GraphHopper setGraphHopperLocation(String ghLocation) { ghLocation = null;
...
public class GraphHopper {
     ...
     */
    public GraphHopper setGraphHopperLocation(String ghLocation) { ghLocation = null;
        ensureNotLoaded();
        if (ghLocation == null)
