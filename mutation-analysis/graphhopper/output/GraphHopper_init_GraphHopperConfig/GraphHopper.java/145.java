...
----> before:         Map<String, String> implicitFlagEncoderMap = new HashMap<>();
----> after:         Map<String, String> implicitFlagEncoderMap = null;
...
public class GraphHopper {
    ...
    private EncodingManager buildEncodingManager(GraphHopperConfig ghConfig) {
        ...
        Map<String, String> implicitFlagEncoderMap = null;
