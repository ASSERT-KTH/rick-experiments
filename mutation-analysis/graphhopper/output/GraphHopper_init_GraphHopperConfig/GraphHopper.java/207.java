...
----> before:             if (loaded.containsKey(profile.getProfile()) && prepared.containsKey(profile.getProfile()))
----> after:             if (loaded.containsKey(profile.getProfile()) || prepared.containsKey(profile.getProfile()))
----> line number in original file: 1041
----> mutated node: 9475
