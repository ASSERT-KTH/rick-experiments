...
----> before:     private List<CHConfig> createCHConfigs(List<CHProfile> chProfiles) {
----> after:     private List<CHConfig> createCHConfigs(List<CHProfile> chProfiles) { chProfiles = null;
----> line number in original file: 870
----> mutated node: 2760
...
public class GraphHopper {
    ...
    private List<CHConfig> createCHConfigs(List<CHProfile> chProfiles) { chProfiles = null;
