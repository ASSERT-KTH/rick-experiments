...
----> before:                 chConfigs.add(CHConfig.edgeBased(profile.getName(), createWeighting(profile, new PMap())));
----> after:                 chConfigs.add(CHConfig.edgeBased(profile.getName(), createWeighting(profile, null)));
----> line number in original file: 875
----> mutated node: 15205
    ...
    private List<CHConfig> createCHConfigs(List<CHProfile> chProfiles) {
        ...
        for (CHProfile chProfile : chProfiles) {
            ...
            if (profile.isTurnCosts()) {
                chConfigs.add(CHConfig.edgeBased(profile.getName(), createWeighting(profile, null)));
            } else {
