...
----> before:                 throw new IllegalArgumentException("Unknown LM preparation profile '" + lmProfile.getPreparationProfile() + "' in LM profile '" + lmProfile.getProfile() + "' cannot be used as preparation_profile");
----> after:                 throw null;
----> line number in original file: 858
----> mutated node: 12628
