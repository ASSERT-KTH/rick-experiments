...
----> before:     private List<LMConfig> createLMConfigs(List<LMProfile> lmProfiles) {
----> after:     private List<LMConfig> createLMConfigs(List<LMProfile> lmProfiles) { lmProfiles = null;
...
public class GraphHopper {
    ...
    private List<LMConfig> createLMConfigs(List<LMProfile> lmProfiles) { lmProfiles = null;
