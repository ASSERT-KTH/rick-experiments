...
----> before:         countryRuleFactory = ghConfig.getBool("country_rules.enabled", false) ? new CountryRuleFactory() : null;
----> after:         countryRuleFactory = ghConfig.getBool("country_rules.enabled", false) ? null : null;
...
public class GraphHopper {
    ...
    public GraphHopper init(GraphHopperConfig ghConfig) {
        ...
        countryRuleFactory = ghConfig.getBool("country_rules.enabled", false) ? null : null;
