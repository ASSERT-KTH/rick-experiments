...
----> before:     public GraphHopper setProfiles(List<Profile> profiles) {
----> after:     public GraphHopper setProfiles(List<Profile> profiles) { profiles = null;
...
public class GraphHopper {
    ...
    public GraphHopper setProfiles(List<Profile> profiles) { profiles = null;
