...
----> before:             if (lmProfile.usesOtherPreparation() && !lmProfileMap.containsKey(lmProfile.getPreparationProfile())) {
----> after:             if (lmProfile.usesOtherPreparation() &&  lmProfileMap.containsKey(lmProfile.getPreparationProfile())) {
