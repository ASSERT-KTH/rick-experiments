...
----> before:     public GraphHopper setElevationProvider(ElevationProvider eleProvider) {
----> after:     public GraphHopper setElevationProvider(ElevationProvider eleProvider) { eleProvider = null;
...
public class GraphHopper {
    ...
    public GraphHopper setElevationProvider(ElevationProvider eleProvider) { eleProvider = null;
