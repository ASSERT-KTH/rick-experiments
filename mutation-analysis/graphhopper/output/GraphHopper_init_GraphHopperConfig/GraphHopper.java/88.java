...
----> before:             Weighting weighting = createWeighting(profile, new PMap(), true);
----> after:             Weighting weighting = createWeighting(profile, null, true);
...
public class GraphHopper {
    ...
    private List<LMConfig> createLMConfigs(List<LMProfile> lmProfiles) {
        ...
        for (LMProfile lmProfile : lmProfiles) {
            ...
            Weighting weighting = createWeighting(profile, null, true);
