...
----> before:                     new Unzipper().unzip(compressed.getAbsolutePath(), ghLocation, removeZipped);
----> after:                     null.unzip(compressed.getAbsolutePath(), ghLocation, removeZipped);
----> line number in original file: 749
----> mutated node: 14918
    ...
    public boolean load() {
        ...
        if (!tmpFileOrFolder.isDirectory() && tmpFileOrFolder.exists()) {
            ...
            if (compressed.exists() && !compressed.isDirectory()) {
                try {
                    null.unzip(compressed.getAbsolutePath(), ghLocation, removeZipped);
                } catch (IOException ex) {
