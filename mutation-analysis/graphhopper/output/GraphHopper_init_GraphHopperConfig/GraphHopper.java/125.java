...
----> before:         List<JsonFeatureCollection> jsonFeatureCollections = new ArrayList<>();
----> after:         List<JsonFeatureCollection> jsonFeatureCollections = null;
...
public class GraphHopper {
    ...
    private List<CustomArea> readCustomAreas() {
        ...
        List<JsonFeatureCollection> jsonFeatureCollections = null;
