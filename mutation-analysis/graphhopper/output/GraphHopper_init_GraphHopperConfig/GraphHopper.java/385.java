...
----> before:     protected List<PrepareLandmarks> prepareLM(boolean closeEarly, List<LMConfig> configsToPrepare) {
----> after:     protected List<PrepareLandmarks> prepareLM(boolean closeEarly, List<LMConfig> configsToPrepare) { configsToPrepare = null;
----> line number in original file: 1094
----> mutated node: 2915
...
public class GraphHopper {
    ...
    protected List<PrepareLandmarks> prepareLM(boolean closeEarly, List<LMConfig> configsToPrepare) { configsToPrepare = null;
        if (!configsToPrepare.isEmpty())
            ensureWriteAccess();
        ghStorage.freeze();
