...
----> before:             StorableProperties properties = new StorableProperties(new GHDirectory(ghLocation, dataAccessDefaultType));
----> after:             StorableProperties properties = new StorableProperties(null);
----> line number in original file: 760
----> mutated node: 14673
...
public class GraphHopper {
    ...
    public boolean load() {
        ...
        if (encodingManager == null) {
            StorableProperties properties = new StorableProperties(null);
