...
----> before:         Map<String, LMProfile> lmProfileMap = new LinkedHashMap<>(lmPreparationHandler.getLMProfiles().size());
----> after:         Map<String, LMProfile> lmProfileMap = null;
----> line number in original file: 843
----> mutated node: 9271
...
public class GraphHopper {
    ...
    private void checkProfilesConsistency() {
        ...
        Map<String, LMProfile> lmProfileMap = null;
