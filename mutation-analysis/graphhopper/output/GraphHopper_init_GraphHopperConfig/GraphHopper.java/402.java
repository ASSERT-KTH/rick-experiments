...
----> after:     public final Weighting createWeighting(Profile profile, PMap hints, boolean disableTurnCosts) { hints = null;
...
public class GraphHopper {
    ...
    public final Weighting createWeighting(Profile profile, PMap hints, boolean disableTurnCosts) { hints = null;
