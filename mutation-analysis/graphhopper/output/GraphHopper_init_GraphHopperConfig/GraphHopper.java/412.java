...
----> before:     public GraphHopper setCustomAreasDirectory(String customAreasDirectory) {
----> after:     public GraphHopper setCustomAreasDirectory(String customAreasDirectory) { customAreasDirectory = null;
...
public class GraphHopper {
    ...
    public GraphHopper setCustomAreasDirectory(String customAreasDirectory) { customAreasDirectory = null;
