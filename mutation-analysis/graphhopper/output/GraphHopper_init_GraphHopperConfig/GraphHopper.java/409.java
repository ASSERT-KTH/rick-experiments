...
----> before:     private EncodingManager buildEncodingManager(GraphHopperConfig ghConfig) {
----> after:     private EncodingManager buildEncodingManager(GraphHopperConfig ghConfig) { ghConfig = null;
----> line number in original file: 517
----> mutated node: 2654
...
public class GraphHopper {
    ...
    private EncodingManager buildEncodingManager(GraphHopperConfig ghConfig) { ghConfig = null;
        if (profilesByName.isEmpty())
