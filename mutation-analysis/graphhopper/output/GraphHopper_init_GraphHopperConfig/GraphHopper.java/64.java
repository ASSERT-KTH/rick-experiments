...
----> before:             Weighting weighting = createWeighting(profile, new PMap().putObject(Parameters.Routing.U_TURN_COSTS, 0));
----> after:             Weighting weighting = createWeighting(profile, null.putObject(Parameters.Routing.U_TURN_COSTS, 0));
----> line number in original file: 1115
----> mutated node: 14586
...
public class GraphHopper {
    ...
    private List<PrepareJob> buildSubnetworkRemovalJobs() {
        ...
        for (Profile profile : profilesByName.values()) {
            ...
            Weighting weighting = createWeighting(profile, null.putObject(Parameters.Routing.U_TURN_COSTS, 0));
