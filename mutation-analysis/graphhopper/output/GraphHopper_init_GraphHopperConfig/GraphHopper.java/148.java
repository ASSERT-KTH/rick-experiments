...
----> before:             throw new IllegalStateException("no profiles exist but assumed to create EncodingManager. E.g. provide them in GraphHopperConfig when calling GraphHopper.init");
----> after:             throw null;
----> line number in original file: 519
----> mutated node: 5609
