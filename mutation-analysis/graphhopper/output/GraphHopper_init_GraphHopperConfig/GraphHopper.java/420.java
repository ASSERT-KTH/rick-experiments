...
----> before:     public Profile getProfile(String profileName) {
----> after:     public Profile getProfile(String profileName) { profileName = null;
...
public class GraphHopper {
     ...
     */
    public Profile getProfile(String profileName) { profileName = null;
