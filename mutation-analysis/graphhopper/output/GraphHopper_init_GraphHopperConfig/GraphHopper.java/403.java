...
----> before:     public final Weighting createWeighting(Profile profile, PMap hints, boolean disableTurnCosts) {
----> after:     public final Weighting createWeighting(Profile profile, PMap hints, boolean disableTurnCosts) { profile = null;
----> line number in original file: 956
----> mutated node: 2804
...
public class GraphHopper {
    ...
    public final Weighting createWeighting(Profile profile, PMap hints, boolean disableTurnCosts) { profile = null;
