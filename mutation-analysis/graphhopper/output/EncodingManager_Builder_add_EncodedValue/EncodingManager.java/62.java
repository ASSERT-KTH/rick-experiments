...
----> before:     public static String getKey(String prefix, String str) {
----> after:     public static String getKey(String prefix, String str) { prefix = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static String getKey(String prefix, String str) { prefix = null;
