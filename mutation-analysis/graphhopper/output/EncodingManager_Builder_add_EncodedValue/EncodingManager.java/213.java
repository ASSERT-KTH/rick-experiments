...
----> before:         private final Map<String, AbstractFlagEncoder> flagEncoderMap = new LinkedHashMap<>();
----> after:         private final Map<String, AbstractFlagEncoder> flagEncoderMap = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        private final Map<String, AbstractFlagEncoder> flagEncoderMap = null;
        private final Map<String, EncodedValue> encodedValueMap = new LinkedHashMap<>();
