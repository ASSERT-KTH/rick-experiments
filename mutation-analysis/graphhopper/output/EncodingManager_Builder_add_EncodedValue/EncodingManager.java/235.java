...
----> before:         if (name.isEmpty() || !isLowerLetter(name.charAt(0)) || KEYWORDS.contains(name)) return false;
----> after:         if (name.isEmpty() && !isLowerLetter(name.charAt(0)) || KEYWORDS.contains(name)) return false;
