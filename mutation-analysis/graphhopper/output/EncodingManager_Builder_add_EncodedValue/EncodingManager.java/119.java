...
----> before:     public static EncodingManager create(FlagEncoderFactory factory, String flagEncodersStr) {
----> after:     public static EncodingManager create(FlagEncoderFactory factory, String flagEncodersStr) { flagEncodersStr = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static EncodingManager create(FlagEncoderFactory factory, String flagEncodersStr) { flagEncodersStr = null;
