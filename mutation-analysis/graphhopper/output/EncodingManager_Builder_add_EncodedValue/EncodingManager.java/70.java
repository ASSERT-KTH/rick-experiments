...
----> after:     public <T extends Enum<?>> EnumEncodedValue<T> getEnumEncodedValue(String key, Class<T> type) { key = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    @Override
    public <T extends Enum<?>> EnumEncodedValue<T> getEnumEncodedValue(String key, Class<T> type) { key = null;
