...
----> before:     public FlagEncoder getEncoder(String name) {
----> after:     public FlagEncoder getEncoder(String name) { name = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public FlagEncoder getEncoder(String name) { name = null;
