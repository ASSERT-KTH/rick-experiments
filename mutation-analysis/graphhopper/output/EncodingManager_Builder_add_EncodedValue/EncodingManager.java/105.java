...
----> before:         public Builder addTurnCostParser(TurnCostParser parser) {
----> after:         public Builder addTurnCostParser(TurnCostParser parser) { parser = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        public Builder addTurnCostParser(TurnCostParser parser) { parser = null;
            check();
