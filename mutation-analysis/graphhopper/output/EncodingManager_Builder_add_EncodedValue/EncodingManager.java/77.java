...
----> before:     public IntsRef handleWayTags(ReaderWay way, IntsRef relationFlags) {
----> after:     public IntsRef handleWayTags(ReaderWay way, IntsRef relationFlags) { relationFlags = null;
----> line number in original file: 470
----> mutated node: 1446
...
public class EncodingManager implements EncodedValueLookup {
     ...
     */
    public IntsRef handleWayTags(ReaderWay way, IntsRef relationFlags) { relationFlags = null;
