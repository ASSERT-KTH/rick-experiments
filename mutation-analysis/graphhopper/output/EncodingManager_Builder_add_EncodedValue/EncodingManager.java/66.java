...
----> before:     public <T extends EncodedValue> T getEncodedValue(String key, Class<T> encodedValueType) {
----> after:     public <T extends EncodedValue> T getEncodedValue(String key, Class<T> encodedValueType) { encodedValueType = null;
----> line number in original file: 600
----> mutated node: 1892
...
public class EncodingManager implements EncodedValueLookup {
    ...
    @Override
    public <T extends EncodedValue> T getEncodedValue(String key, Class<T> encodedValueType) { encodedValueType = null;
