...
----> before:         public Builder add(FlagEncoder encoder) {
----> after:         public Builder add(FlagEncoder encoder) { encoder = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        public Builder add(FlagEncoder encoder) { encoder = null;
            check();
