...
----> before:                         _addEdgeTagParser(new DefaultTagParserFactory().create("bike_access", new PMap()), false);
----> after:                         _addEdgeTagParser(new DefaultTagParserFactory().create("bike_access", null), false);
            ...
            for (AbstractFlagEncoder encoder : flagEncoderMap.values()) {
                if (encoder instanceof RoadsFlagEncoder) {
                    ...
                    if (!em.hasEncodedValue("bike_access"))
                        _addEdgeTagParser(new DefaultTagParserFactory().create("bike_access", null), false);
