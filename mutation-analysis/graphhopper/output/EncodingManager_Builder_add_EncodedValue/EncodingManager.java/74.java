...
----> before:     public void applyWayTags(ReaderWay way, EdgeIteratorState edge) {
----> after:     public void applyWayTags(ReaderWay way, EdgeIteratorState edge) { edge = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public void applyWayTags(ReaderWay way, EdgeIteratorState edge) { edge = null;
        for (AbstractFlagEncoder encoder : edgeEncoders)
