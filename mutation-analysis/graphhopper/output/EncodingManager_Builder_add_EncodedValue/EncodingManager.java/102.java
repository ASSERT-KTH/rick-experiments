...
----> before:         public Builder add(EncodedValue encodedValue) {
----> after:         public Builder add(EncodedValue encodedValue) { encodedValue = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        public Builder add(EncodedValue encodedValue) { encodedValue = null;
            check();
