...
----> before:     private final Map<String, TurnCostParser> turnCostParsers = new LinkedHashMap<>();
----> after:     private final Map<String, TurnCostParser> turnCostParsers = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    private final Map<String, TurnCostParser> turnCostParsers = null;
