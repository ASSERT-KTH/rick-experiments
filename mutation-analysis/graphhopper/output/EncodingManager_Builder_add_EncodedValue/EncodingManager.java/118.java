...
----> before:     public static EncodingManager create(FlagEncoder... flagEncoders) {
----> after:     public static EncodingManager create(FlagEncoder... flagEncoders) { flagEncoders = null;
...
public class EncodingManager implements EncodedValueLookup {
     ...
     */
    public static EncodingManager create(FlagEncoder... flagEncoders) { flagEncoders = null;
