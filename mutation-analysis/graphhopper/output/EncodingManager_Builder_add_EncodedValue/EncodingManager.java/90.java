...
----> before:     private void addEncoder(AbstractFlagEncoder encoder) {
----> after:     private void addEncoder(AbstractFlagEncoder encoder) { encoder = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    private void addEncoder(AbstractFlagEncoder encoder) { encoder = null;
