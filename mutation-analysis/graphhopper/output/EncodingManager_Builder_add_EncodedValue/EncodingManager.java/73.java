...
----> before:     public BooleanEncodedValue getBooleanEncodedValue(String key) {
----> after:     public BooleanEncodedValue getBooleanEncodedValue(String key) { key = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    @Override
    public BooleanEncodedValue getBooleanEncodedValue(String key) { key = null;
