...
----> before:     static FlagEncoder parseEncoderString(FlagEncoderFactory factory, String encoderString) {
----> after:     static FlagEncoder parseEncoderString(FlagEncoderFactory factory, String encoderString) { encoderString = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    static FlagEncoder parseEncoderString(FlagEncoderFactory factory, String encoderString) { encoderString = null;
