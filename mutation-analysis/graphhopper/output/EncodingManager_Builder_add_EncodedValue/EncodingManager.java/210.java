...
----> before:         private final List<TurnCostParser> turnCostParsers = new ArrayList<>();
----> after:         private final List<TurnCostParser> turnCostParsers = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        private final List<TurnCostParser> turnCostParsers = null;
        private final List<RelationTagParser> relationTagParsers = new ArrayList<>();
