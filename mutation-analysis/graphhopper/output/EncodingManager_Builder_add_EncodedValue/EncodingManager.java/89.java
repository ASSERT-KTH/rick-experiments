...
----> before:     private void addEncodedValue(EncodedValue ev, boolean withNamespace) {
----> after:     private void addEncodedValue(EncodedValue ev, boolean withNamespace) { ev = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    private void addEncodedValue(EncodedValue ev, boolean withNamespace) { ev = null;
