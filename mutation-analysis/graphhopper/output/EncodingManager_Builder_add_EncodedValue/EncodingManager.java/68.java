...
----> before:     public StringEncodedValue getStringEncodedValue(String key) {
----> after:     public StringEncodedValue getStringEncodedValue(String key) { key = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    @Override
    public StringEncodedValue getStringEncodedValue(String key) { key = null;
