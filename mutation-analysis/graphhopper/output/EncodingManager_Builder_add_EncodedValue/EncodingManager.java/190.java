...
----> before:                         _addEdgeTagParser(new DefaultTagParserFactory().create("car_access", new PMap()), false);
----> after:                         _addEdgeTagParser(new DefaultTagParserFactory().create("car_access", null), false);
            ...
            for (AbstractFlagEncoder encoder : flagEncoderMap.values()) {
                if (encoder instanceof RoadsFlagEncoder) {
                    ...
                    if (!em.hasEncodedValue("car_access"))
                        _addEdgeTagParser(new DefaultTagParserFactory().create("car_access", null), false);
