...
----> before:     public boolean hasEncodedValue(String key) {
----> after:     public boolean hasEncodedValue(String key) { key = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public boolean hasEncodedValue(String key) { key = null;
