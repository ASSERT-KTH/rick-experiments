...
----> before:     public static EncodingManager create(List<? extends FlagEncoder> flagEncoders) {
----> after:     public static EncodingManager create(List<? extends FlagEncoder> flagEncoders) { flagEncoders = null;
...
public class EncodingManager implements EncodedValueLookup {
     ...
     * Instantiate manager with the given list of encoders.
     */
    public static EncodingManager create(List<? extends FlagEncoder> flagEncoders) { flagEncoders = null;
