...
----> before:         private void _addEdgeTagParser(TagParser tagParser, boolean withNamespace) {
----> after:         private void _addEdgeTagParser(TagParser tagParser, boolean withNamespace) { tagParser = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        private void _addEdgeTagParser(TagParser tagParser, boolean withNamespace) { tagParser = null;
