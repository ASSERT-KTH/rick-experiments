...
----> before:         public Builder addRelationTagParser(RelationTagParser tagParser) {
----> after:         public Builder addRelationTagParser(RelationTagParser tagParser) { tagParser = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        public Builder addRelationTagParser(RelationTagParser tagParser) { tagParser = null;
            check();
