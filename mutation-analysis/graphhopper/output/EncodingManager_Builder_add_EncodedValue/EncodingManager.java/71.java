...
----> before:     public DecimalEncodedValue getDecimalEncodedValue(String key) {
----> after:     public DecimalEncodedValue getDecimalEncodedValue(String key) { key = null;
----> line number in original file: 584
----> mutated node: 1530
...
public class EncodingManager implements EncodedValueLookup {
    ...
    @Override
    public DecimalEncodedValue getDecimalEncodedValue(String key) { key = null;
