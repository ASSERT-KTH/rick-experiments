...
----> before:     public static boolean isValidEncodedValue(String name) {
----> after:     public static boolean isValidEncodedValue(String name) { name = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static boolean isValidEncodedValue(String name) { name = null;
