...
----> after:     public <T extends EncodedValue> T getEncodedValue(String key, Class<T> encodedValueType) { key = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    @Override
    public <T extends EncodedValue> T getEncodedValue(String key, Class<T> encodedValueType) { key = null;
