...
----> before:     public IntsRef handleRelationTags(ReaderRelation relation, IntsRef relFlags) {
----> after:     public IntsRef handleRelationTags(ReaderRelation relation, IntsRef relFlags) { relFlags = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public IntsRef handleRelationTags(ReaderRelation relation, IntsRef relFlags) { relFlags = null;
