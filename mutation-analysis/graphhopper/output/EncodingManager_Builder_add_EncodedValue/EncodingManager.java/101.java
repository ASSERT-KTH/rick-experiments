...
----> before:         public Builder add(TagParser tagParser) {
----> after:         public Builder add(TagParser tagParser) { tagParser = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
         ...
         * createEncodedValues.
         */
        public Builder add(TagParser tagParser) { tagParser = null;
            check();
