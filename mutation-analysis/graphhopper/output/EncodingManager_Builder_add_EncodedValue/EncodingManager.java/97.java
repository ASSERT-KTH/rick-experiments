...
----> before:         private void _addTurnCostParser(TurnCostParser parser) {
----> after:         private void _addTurnCostParser(TurnCostParser parser) { parser = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        private void _addTurnCostParser(TurnCostParser parser) { parser = null;
            List<EncodedValue> list = new ArrayList<>();
