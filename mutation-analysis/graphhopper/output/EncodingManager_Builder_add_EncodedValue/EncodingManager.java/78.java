...
----> after:     public IntsRef handleWayTags(ReaderWay way, IntsRef relationFlags) { way = null;
...
public class EncodingManager implements EncodedValueLookup {
     ...
     */
    public IntsRef handleWayTags(ReaderWay way, IntsRef relationFlags) { way = null;
