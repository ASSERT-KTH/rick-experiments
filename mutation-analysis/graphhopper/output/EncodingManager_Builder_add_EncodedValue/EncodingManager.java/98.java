...
----> before:         private void _addRelationTagParser(RelationTagParser tagParser) {
----> after:         private void _addRelationTagParser(RelationTagParser tagParser) { tagParser = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        private void _addRelationTagParser(RelationTagParser tagParser) { tagParser = null;
            List<EncodedValue> list = new ArrayList<>();
