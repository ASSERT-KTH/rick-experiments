...
----> before:     public boolean hasEncoder(String encoder) {
----> after:     public boolean hasEncoder(String encoder) { encoder = null;
...
public class EncodingManager implements EncodedValueLookup {
     ...
     */
    public boolean hasEncoder(String encoder) { encoder = null;
