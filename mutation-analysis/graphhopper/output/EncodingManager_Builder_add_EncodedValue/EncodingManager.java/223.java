...
----> before:     private final Map<String, EncodedValue> encodedValueMap = new LinkedHashMap<>();
----> after:     private final Map<String, EncodedValue> encodedValueMap = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    private final Map<String, EncodedValue> encodedValueMap = null;
