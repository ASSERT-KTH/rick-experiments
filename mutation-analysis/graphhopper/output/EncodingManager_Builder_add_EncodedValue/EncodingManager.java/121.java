...
----> before:     public static EncodingManager create(String flagEncodersStr) {
----> after:     public static EncodingManager create(String flagEncodersStr) { flagEncodersStr = null;
...
public class EncodingManager implements EncodedValueLookup {
     ...
     */
    public static EncodingManager create(String flagEncodersStr) { flagEncodersStr = null;
