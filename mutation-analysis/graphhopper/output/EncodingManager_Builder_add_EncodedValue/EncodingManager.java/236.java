...
----> before:         return isValidEncodedValue(ev.getName()) && !ev.getName().contains(SPECIAL_SEPARATOR);
----> after:         return isValidEncodedValue(ev.getName()) || !ev.getName().contains(SPECIAL_SEPARATOR);
----> line number in original file: 610
----> mutated node: 2436
