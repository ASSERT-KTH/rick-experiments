...
----> before:         public Builder setDateRangeParser(DateRangeParser dateRangeParser) {
----> after:         public Builder setDateRangeParser(DateRangeParser dateRangeParser) { dateRangeParser = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static class Builder {
        ...
        public Builder setDateRangeParser(DateRangeParser dateRangeParser) { dateRangeParser = null;
            check();
