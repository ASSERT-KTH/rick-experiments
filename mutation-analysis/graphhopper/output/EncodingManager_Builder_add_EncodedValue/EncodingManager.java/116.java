...
----> before:     private static EncodingManager.Builder createBuilder(List<? extends FlagEncoder> flagEncoders) {
----> after:     private static EncodingManager.Builder createBuilder(List<? extends FlagEncoder> flagEncoders) { flagEncoders = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    private static EncodingManager.Builder createBuilder(List<? extends FlagEncoder> flagEncoders) { flagEncoders = null;
