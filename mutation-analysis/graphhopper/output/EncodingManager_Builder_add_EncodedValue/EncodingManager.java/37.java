...
----> before:         return edgeEncoders.stream().anyMatch(encoder -> !encoder.getAccess(way).equals(Access.CAN_SKIP));
----> after:         return edgeEncoders.stream().anyMatch(encoder ->  encoder.getAccess(way).equals(Access.CAN_SKIP));
