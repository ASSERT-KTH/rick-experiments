...
----> before:     private static boolean isSharedEncodedValues(EncodedValue ev) {
----> after:     private static boolean isSharedEncodedValues(EncodedValue ev) { ev = null;
----> line number in original file: 609
----> mutated node: 1565
...
public class EncodingManager implements EncodedValueLookup {
    ...
    private static boolean isSharedEncodedValues(EncodedValue ev) { ev = null;
