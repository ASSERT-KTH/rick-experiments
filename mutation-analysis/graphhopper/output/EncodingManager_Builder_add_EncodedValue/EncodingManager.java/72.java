...
----> before:     public IntEncodedValue getIntEncodedValue(String key) {
----> after:     public IntEncodedValue getIntEncodedValue(String key) { key = null;
...
public class EncodingManager implements EncodedValueLookup {
    ...
    @Override
    public IntEncodedValue getIntEncodedValue(String key) { key = null;
