...
----> before:                 if (encoder.supportsTurnCosts() && !em.turnCostParsers.containsKey(encoder.toString()))
----> after:                 if (encoder.supportsTurnCosts() || !em.turnCostParsers.containsKey(encoder.toString()))
