...
----> before:     public static String getKey(FlagEncoder encoder, String str) {
----> after:     public static String getKey(FlagEncoder encoder, String str) { encoder = null;
----> line number in original file: 617
----> mutated node: 1572
...
public class EncodingManager implements EncodedValueLookup {
     ...
     */
    public static String getKey(FlagEncoder encoder, String str) { encoder = null;
