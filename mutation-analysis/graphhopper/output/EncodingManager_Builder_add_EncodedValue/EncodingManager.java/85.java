...
----> before:     private FlagEncoder getEncoder(String name, boolean throwExc) {
----> after:     private FlagEncoder getEncoder(String name, boolean throwExc) { name = null;
----> line number in original file: 413
----> mutated node: 1404
...
public class EncodingManager implements EncodedValueLookup {
    ...
    private FlagEncoder getEncoder(String name, boolean throwExc) { name = null;
