...
----> before:     private byte[] getBytesForString(String info, String name) {
----> after:     private byte[] getBytesForString(String info, String name) { name = null;
...
public class StringIndex {
    ...
    private byte[] getBytesForString(String info, String name) { name = null;
