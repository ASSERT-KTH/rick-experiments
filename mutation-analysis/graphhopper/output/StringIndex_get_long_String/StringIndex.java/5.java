...
----> before:                 throw new IllegalStateException(info + " is too long: " + name + " truncated to " + newString);
----> after:                 throw new IllegalStateException(info + " is too long: " - name + " truncated to " + newString);
