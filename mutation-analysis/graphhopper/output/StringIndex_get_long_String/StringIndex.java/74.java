...
----> before:     private final Map<String, Integer> keysInMem = new LinkedHashMap<>();
----> after:     private final Map<String, Integer> keysInMem = null;
...
public class StringIndex {
    ...
    private final Map<String, Integer> keysInMem = null;
