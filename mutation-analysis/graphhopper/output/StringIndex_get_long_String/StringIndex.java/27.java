...
----> before:     public long add(Map<String, String> entryMap) {
----> after:     public long add(Map<String, String> entryMap) { entryMap = null;
...
public class StringIndex {
     ...
     */
    public long add(Map<String, String> entryMap) { entryMap = null;
        if (entryMap.isEmpty())
