...
----> before:     public String get(final long entryPointer, String key) {
----> after:     public String get(final long entryPointer, String key) { key = null;
...
public class StringIndex {
    ...
    public String get(final long entryPointer, String key) { key = null;
        if (entryPointer < 0)
            throw new IllegalStateException("Pointer to access StringIndex cannot be negative:" + entryPointer);
