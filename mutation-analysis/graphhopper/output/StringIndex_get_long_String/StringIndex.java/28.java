...
----> before:             protected boolean removeEldestEntry(Map.Entry<String, Long> entry) {
----> after:             protected boolean removeEldestEntry(Map.Entry<String, Long> entry) { entry = null;
...
public class StringIndex {
    ...
    public StringIndex(Directory dir, final int cacheSize, final int segmentSize) {
        ...
        smallCache = new LinkedHashMap<String, Long>(cacheSize, 0.75f, true) {
            @Override
            protected boolean removeEldestEntry(Map.Entry<String, Long> entry) { entry = null;
