...
----> before:     private int putIntoMap(Map<String, String> map, long tmpPointer, int currentKeyIndex) {
----> after:     private int putIntoMap(Map<String, String> map, long tmpPointer, int currentKeyIndex) { map = null;
...
public class StringIndex {
    ...
    private int putIntoMap(Map<String, String> map, long tmpPointer, int currentKeyIndex) { map = null;
