...
----> before:     public <T extends Enum<?>> T getReverse(EnumEncodedValue<T> property) {
----> after:     public <T extends Enum<?>> T getReverse(EnumEncodedValue<T> property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public <T extends Enum<?>> T getReverse(EnumEncodedValue<T> property) { property = null;
        return property.getEnum(!reverse, edgeFlags);
    }
