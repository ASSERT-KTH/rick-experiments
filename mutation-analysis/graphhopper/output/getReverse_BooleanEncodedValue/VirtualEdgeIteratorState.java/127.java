...
----> before:     public EdgeIteratorState set(IntEncodedValue property, int value) {
----> after:     public EdgeIteratorState set(IntEncodedValue property, int value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(IntEncodedValue property, int value) { property = null;
