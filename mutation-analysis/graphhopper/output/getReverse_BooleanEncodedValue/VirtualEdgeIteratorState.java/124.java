...
----> before:     public EdgeIteratorState set(IntEncodedValue property, int fwd, int bwd) {
----> after:     public EdgeIteratorState set(IntEncodedValue property, int fwd, int bwd) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(IntEncodedValue property, int fwd, int bwd) { property = null;
        if (!property.isStoreTwoDirections())
            throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
