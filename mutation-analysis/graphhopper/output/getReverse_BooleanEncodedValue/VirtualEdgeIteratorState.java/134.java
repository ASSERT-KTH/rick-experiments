...
----> before:     public EdgeIteratorState setFlags(IntsRef flags) {
----> after:     public EdgeIteratorState setFlags(IntsRef flags) { flags = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState setFlags(IntsRef flags) { flags = null;
