...
----> before:     public EdgeIteratorState set(BooleanEncodedValue property, boolean value) {
----> after:     public EdgeIteratorState set(BooleanEncodedValue property, boolean value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(BooleanEncodedValue property, boolean value) { property = null;
