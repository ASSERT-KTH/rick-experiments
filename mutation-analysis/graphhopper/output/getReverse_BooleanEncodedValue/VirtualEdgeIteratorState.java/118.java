...
----> before:     public <T extends Enum<?>> T get(EnumEncodedValue<T> property) {
----> after:     public <T extends Enum<?>> T get(EnumEncodedValue<T> property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public <T extends Enum<?>> T get(EnumEncodedValue<T> property) { property = null;
