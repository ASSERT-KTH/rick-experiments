...
----> before:     public EdgeIteratorState set(StringEncodedValue property, String fwd, String bwd) {
----> after:     public EdgeIteratorState set(StringEncodedValue property, String fwd, String bwd) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(StringEncodedValue property, String fwd, String bwd) { property = null;
        if (!property.isStoreTwoDirections())
            throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
