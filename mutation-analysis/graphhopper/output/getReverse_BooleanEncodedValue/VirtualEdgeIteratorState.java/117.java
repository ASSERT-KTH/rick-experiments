...
----> before:     public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T value) {
----> after:     public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T value) { property = null;
