...
----> after:     public EdgeIteratorState setReverse(StringEncodedValue property, String value) { value = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState setReverse(StringEncodedValue property, String value) { value = null;
        property.setString(!reverse, edgeFlags, value);
        return this;
    }
