...
----> before:     public EdgeIteratorState setReverse(DecimalEncodedValue property, double value) {
----> after:     public EdgeIteratorState setReverse(DecimalEncodedValue property, double value) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState setReverse(DecimalEncodedValue property, double value) { property = null;
        property.setDecimal(!reverse, edgeFlags, value);
        return this;
    }
