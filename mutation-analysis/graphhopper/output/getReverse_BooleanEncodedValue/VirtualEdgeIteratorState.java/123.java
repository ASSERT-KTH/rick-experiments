...
----> before:     public double get(DecimalEncodedValue property) {
----> after:     public double get(DecimalEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public double get(DecimalEncodedValue property) { property = null;
