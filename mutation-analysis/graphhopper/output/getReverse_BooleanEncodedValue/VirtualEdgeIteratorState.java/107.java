...
----> after:     public EdgeIteratorState set(StringEncodedValue property, String value) { value = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(StringEncodedValue property, String value) { value = null;
