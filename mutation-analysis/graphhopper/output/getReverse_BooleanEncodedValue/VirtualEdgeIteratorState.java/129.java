...
----> before:     public EdgeIteratorState set(BooleanEncodedValue property, boolean fwd, boolean bwd) {
----> after:     public EdgeIteratorState set(BooleanEncodedValue property, boolean fwd, boolean bwd) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public EdgeIteratorState set(BooleanEncodedValue property, boolean fwd, boolean bwd) { property = null;
