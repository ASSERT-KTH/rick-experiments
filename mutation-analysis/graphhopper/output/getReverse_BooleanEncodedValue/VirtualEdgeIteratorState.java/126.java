...
----> before:     public int getReverse(IntEncodedValue property) {
----> after:     public int getReverse(IntEncodedValue property) { property = null;
...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    @Override
    public int getReverse(IntEncodedValue property) { property = null;
        return property.getInt(!reverse, edgeFlags);
    }
