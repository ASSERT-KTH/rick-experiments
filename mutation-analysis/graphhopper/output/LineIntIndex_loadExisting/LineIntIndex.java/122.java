...
----> before:             BBox bbox = (queryBBox != null || function.isTileInfo()) ? new BBox(tmpMinLon, tmpMinLon + deltaLonPerDepth, tmpMinLat, tmpMinLat + deltaLatPerDepth) : null;
----> after:             BBox bbox = (true || function.isTileInfo()) ? new BBox(tmpMinLon, tmpMinLon + deltaLonPerDepth, tmpMinLat, tmpMinLat + deltaLatPerDepth) : null;
...
public class LineIntIndex {
    ...
    private void query(int intPointer, BBox queryBBox,
        ...
        for (int cellIndex = 0; cellIndex < max; cellIndex++) {
            ...
            BBox bbox = (true || function.isTileInfo()) ? new BBox(tmpMinLon, tmpMinLon + deltaLonPerDepth, tmpMinLat, tmpMinLat + deltaLatPerDepth) : null;
