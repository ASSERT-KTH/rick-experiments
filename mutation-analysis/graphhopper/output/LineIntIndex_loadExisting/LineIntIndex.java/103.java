...
----> before:     private void fillIDs(long keyPart, IntConsumer consumer) {
----> after:     private void fillIDs(long keyPart, IntConsumer consumer) { consumer = null;
...
public class LineIntIndex {
    ...
    private void fillIDs(long keyPart, IntConsumer consumer) { consumer = null;
