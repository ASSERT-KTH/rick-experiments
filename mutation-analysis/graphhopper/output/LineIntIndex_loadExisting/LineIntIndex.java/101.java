...
----> before:     public void query(BBox queryShape, final LocationIndex.Visitor function) {
----> after:     public void query(BBox queryShape, final LocationIndex.Visitor function) { queryShape = null;
...
public class LineIntIndex {
    ...
    public void query(BBox queryShape, final LocationIndex.Visitor function) { queryShape = null;
