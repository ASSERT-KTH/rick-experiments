...
----> before:     private int store(InMemConstructionIndex.InMemEntry entry, int intPointer) {
----> after:     private int store(InMemConstructionIndex.InMemEntry entry, int intPointer) { entry = null;
...
public class LineIntIndex {
    ...
    private int store(InMemConstructionIndex.InMemEntry entry, int intPointer) { entry = null;
