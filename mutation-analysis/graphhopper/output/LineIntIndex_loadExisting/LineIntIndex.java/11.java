...
----> before:             if (iteration > 0 && subqueryXB >= 0 && subqueryY >= 0 && subqueryXB < indexStructureInfo.getParts() && subqueryY < indexStructureInfo.getParts()) {
----> after:             if (iteration > 0 && subqueryXB >= 0 && subqueryY >= 0 && subqueryXB >= indexStructureInfo.getParts() && subqueryY < indexStructureInfo.getParts()) {
----> line number in original file: 244
----> mutated node: 2635
