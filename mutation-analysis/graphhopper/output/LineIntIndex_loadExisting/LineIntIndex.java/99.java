...
----> before:                        LocationIndex.Visitor function, int depth) {
----> after:                        LocationIndex.Visitor function, int depth) { queryBBox = null;
...
public class LineIntIndex {
    ...
    private void query(int intPointer, BBox queryBBox,
                       ...
                       LocationIndex.Visitor function, int depth) { queryBBox = null;
        long pointer = (long) intPointer * 4;
