...
----> after:     public void query(BBox queryShape, final LocationIndex.Visitor function) { function = null;
...
public class LineIntIndex {
    ...
    public void query(BBox queryShape, final LocationIndex.Visitor function) { function = null;
