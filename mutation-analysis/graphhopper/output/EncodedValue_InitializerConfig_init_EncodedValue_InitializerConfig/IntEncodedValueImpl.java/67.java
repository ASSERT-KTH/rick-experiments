...
----> before:     static int staticHashCode(Collection<String> vals) {
----> after:     static int staticHashCode(Collection<String> vals) { vals = null;
...
public class IntEncodedValueImpl implements IntEncodedValue {
     ...
     * of openjdk.
     */
    static int staticHashCode(Collection<String> vals) { vals = null;
        if (vals == null)
            return 0;
        int val = 1;
        for (String str : vals) {
