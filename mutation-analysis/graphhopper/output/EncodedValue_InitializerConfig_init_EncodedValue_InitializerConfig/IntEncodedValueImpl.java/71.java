...
----> before:     final void uncheckedSet(boolean reverse, IntsRef ref, int value) {
----> after:     final void uncheckedSet(boolean reverse, IntsRef ref, int value) { ref = null;
...
public class IntEncodedValueImpl implements IntEncodedValue {
    ...
    final void uncheckedSet(boolean reverse, IntsRef ref, int value) { ref = null;
