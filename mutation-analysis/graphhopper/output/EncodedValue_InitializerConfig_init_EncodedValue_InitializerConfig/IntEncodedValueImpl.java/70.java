...
----> before:     public final int getInt(boolean reverse, IntsRef ref) {
----> after:     public final int getInt(boolean reverse, IntsRef ref) { ref = null;
...
public class IntEncodedValueImpl implements IntEncodedValue {
    ...
    @Override
    public final int getInt(boolean reverse, IntsRef ref) { ref = null;
        int flags;
