...
----> before:     public final int init(EncodedValue.InitializerConfig init) {
----> after:     public final int init(EncodedValue.InitializerConfig init) { init = null;
...
public class IntEncodedValueImpl implements IntEncodedValue {
    ...
    @Override
    public final int init(EncodedValue.InitializerConfig init) { init = null;
        if (isInitialized())
