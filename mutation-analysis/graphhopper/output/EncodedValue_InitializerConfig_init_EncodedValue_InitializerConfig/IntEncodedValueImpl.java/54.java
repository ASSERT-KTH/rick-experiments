...
----> before:             throw new IllegalArgumentException(name + " value too small for encoding " + value + ", minValue:" + minValue);
----> after:             throw new IllegalArgumentException(name + " value too small for encoding " + value + ", minValue:" - minValue);
