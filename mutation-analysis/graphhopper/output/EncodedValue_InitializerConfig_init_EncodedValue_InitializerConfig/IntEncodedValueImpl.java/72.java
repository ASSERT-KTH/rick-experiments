...
----> before:     public final void setInt(boolean reverse, IntsRef ref, int value) {
----> after:     public final void setInt(boolean reverse, IntsRef ref, int value) { ref = null;
...
public class IntEncodedValueImpl implements IntEncodedValue {
    ...
    @Override
    public final void setInt(boolean reverse, IntsRef ref, int value) { ref = null;
        checkValue(value);
