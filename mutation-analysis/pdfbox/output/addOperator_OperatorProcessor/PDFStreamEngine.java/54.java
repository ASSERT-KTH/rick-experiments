...
----> before:             a.concatenate(Matrix.getScaleInstance((float)(rect.getWidth() / transformedBox.getWidth()),
----> after:             a.concatenate(Matrix.getScaleInstance((float)(rect.getWidth() * transformedBox.getWidth()),
