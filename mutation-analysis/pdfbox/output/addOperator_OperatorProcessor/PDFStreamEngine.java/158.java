...
----> before:     private final Map<String, OperatorProcessor> operators = new HashMap<String, OperatorProcessor>(80);
----> after:     private final Map<String, OperatorProcessor> operators = null;
...
public abstract class PDFStreamEngine
{
    ...
    private final Map<String, OperatorProcessor> operators = null;
