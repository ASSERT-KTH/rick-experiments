...
----> before:         PDLineDashPattern lineDash = new PDLineDashPattern(array, phase);
----> after:         PDLineDashPattern lineDash = null;
----> line number in original file: 1091
----> mutated node: 5867
...
public abstract class PDFStreamEngine
{
    ...
    public void setLineDashPattern(COSArray array, int phase)
    {
        ...
        PDLineDashPattern lineDash = null;
