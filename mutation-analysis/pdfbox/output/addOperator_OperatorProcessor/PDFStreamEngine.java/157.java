...
----> before:     private Deque<PDGraphicsState> graphicsStack = new ArrayDeque<PDGraphicsState>();
----> after:     private Deque<PDGraphicsState> graphicsStack = null;
...
public abstract class PDFStreamEngine
{
    ...
    private Deque<PDGraphicsState> graphicsStack = null;
