...
----> before:         List<PDViewportDictionary> viewports = new ArrayList<PDViewportDictionary>();
----> after:         List<PDViewportDictionary> viewports = null;
...
public class PDPage implements COSObjectable, PDContentStream
{
    ...
    public List<PDViewportDictionary> getViewports()
    {
        ...
        COSArray array = (COSArray) base;
        List<PDViewportDictionary> viewports = null;
        for (int i = 0; i < array.size(); ++i)
        {
