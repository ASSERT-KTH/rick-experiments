...
----> before:         return other instanceof PDPage && ((PDPage) other).getCOSObject() == this.getCOSObject();
----> after:         return other instanceof PDPage || ((PDPage) other).getCOSObject() == this.getCOSObject();
----> line number in original file: 720
----> mutated node: 1955
