...
public class TestPDPageRickGenSetResources {
    ...
    @Test
    @DisplayName("setResources-1 with parameter oracle, mocking [org.apache.pdfbox.cos.COSDictionary.setItem(org.apache.pdfbox.cos.COSName,org.apache.pdfbox.pdmodel.common.COSObjectable)]")
    public void test_setResources_PO_72457e496e9e40219bc1ccdb49656d55() throws Exception {
        // Arrange
        PDPage receivingObject = deserializeObjectFromFile("org.apache.pdfbox.pdmodel.PDPage.setResources1-receiving.xml");
        Object[] paramObjects = deserializeObjectFromFile("org.apache.pdfbox.pdmodel.PDPage.setResources1-params.xml");
        PDResources paramObject1 = (PDResources) paramObjects[0];
...
//        Mockito.verify(mockCOSDictionary, Mockito.atLeastOnce()).setItem(any(org.apache.pdfbox.cos.COSName.class),   any(org.apache.pdfbox.pdmodel.common.COSObjectable.class));
    ...
    @Test
    @DisplayName("setResources-1 with call oracle, mocking [org.apache.pdfbox.cos.COSDictionary.setItem(org.apache.pdfbox.cos.COSName,org.apache.pdfbox.pdmodel.common.COSObjectable)]")
    public void test_setResources_CO_72457e496e9e40219bc1ccdb49656d55() throws Exception {
        // Arrange
        PDPage receivingObject = deserializeObjectFromFile("org.apache.pdfbox.pdmodel.PDPage.setResources1-receiving.xml");
        Object[] paramObjects = deserializeObjectFromFile("org.apache.pdfbox.pdmodel.PDPage.setResources1-params.xml");
        PDResources paramObject1 = (PDResources) paramObjects[0];
