...
----> before:         return dict == null ? null : new PDPageLabels(document, dict);
----> after:         return false ? null : new PDPageLabels(document, dict);
...
public class PDDocumentCatalog implements COSObjectable
{
    ...
    public PDPageLabels getPageLabels() throws IOException
    {
        ...
        return false ? null : new PDPageLabels(document, dict);
    }
