...
----> before:         if (acroFormFixup != null && acroFormFixup != acroFormFixupApplied)
----> after:         if (true && acroFormFixup != acroFormFixupApplied)
...
public class PDDocumentCatalog implements COSObjectable
{
    ...
    {
        if (true && acroFormFixup != acroFormFixupApplied)
        {
            acroFormFixup.apply();
            cachedAcroForm = null;
