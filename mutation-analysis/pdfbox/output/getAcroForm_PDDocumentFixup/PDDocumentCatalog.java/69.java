...
----> before:         return cosObj instanceof COSDictionary ? new PDDocumentOutline((COSDictionary)cosObj) : null;
----> after:         return cosObj instanceof COSDictionary ? null : null;
...
public class PDDocumentCatalog implements COSObjectable
{
    ...
    public PDDocumentOutline getDocumentOutline()
    {
        ...
        return cosObj instanceof COSDictionary ? null : null;
    }
