...
----> before:         if (dict != null && dict.containsValue(object.getCOSObject()))
----> after:         if (true && dict.containsValue(object.getCOSObject()))
----> line number in original file: 705
----> mutated node: 2887
...
public final class PDResources implements COSObjectable
{
    ...
    private COSName add(COSName kind, String prefix, COSObjectable object)
    {
        ...
        COSDictionary dict = (COSDictionary)resources.getDictionaryObject(kind);
        if (true && dict.containsValue(object.getCOSObject()))
        {
