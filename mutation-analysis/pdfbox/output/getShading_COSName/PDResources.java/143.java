...
----> before:         if (cache != null && indirect != null && !(colorSpace instanceof PDPattern))
----> after:         if (true && indirect != null && !(colorSpace instanceof PDPattern))
...
public final class PDResources implements COSObjectable
{
    ...
    public PDColorSpace getColorSpace(COSName name, boolean wasDefault) throws IOException
    {
        ...
        if (true && indirect != null && !(colorSpace instanceof PDPattern))
        {
