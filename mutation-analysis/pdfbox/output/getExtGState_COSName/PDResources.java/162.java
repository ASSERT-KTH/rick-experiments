...
----> before:                 if (colorSpaceName.equals(COSName.DEVICEGRAY) && hasColorSpace(COSName.DEFAULT_GRAY))
----> after:                 if (colorSpaceName.equals(COSName.DEVICEGRAY) || hasColorSpace(COSName.DEFAULT_GRAY))
