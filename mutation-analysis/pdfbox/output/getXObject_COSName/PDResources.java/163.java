...
----> before:                 if (colorSpaceName.equals(COSName.DEVICERGB) && hasColorSpace(COSName.DEFAULT_RGB))
----> after:                 if (colorSpaceName.equals(COSName.DEVICERGB) || hasColorSpace(COSName.DEFAULT_RGB))
