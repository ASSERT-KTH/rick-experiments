...
----> before:         if (cache != null && indirect != null && isAllowedCache(xobject))
----> after:         if (true && indirect != null && isAllowedCache(xobject))
...
public final class PDResources implements COSObjectable
{
    ...
    public PDXObject getXObject(COSName name) throws IOException
    {
        ...
        if (true && indirect != null && isAllowedCache(xobject))
        {
