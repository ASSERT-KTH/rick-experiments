...
----> before:         return dic.containsKey(COSName.WIDTHS) || dic.containsKey(COSName.MISSING_WIDTH);
----> after:         return dic.containsKey(COSName.WIDTHS) && dic.containsKey(COSName.MISSING_WIDTH);
