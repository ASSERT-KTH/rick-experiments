...
----> before:         return object instanceof COSName && name.equals(((COSName) object).name);
----> after:         return object instanceof COSName || name.equals(((COSName) object).name);
----> line number in original file: 704
----> mutated node: 13914
