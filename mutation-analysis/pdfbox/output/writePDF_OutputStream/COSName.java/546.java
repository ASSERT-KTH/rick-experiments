...
----> before:     private static final Map<String, COSName> nameMap = new ConcurrentHashMap<String, COSName>(
----> after:     private static final Map<String, COSName> nameMap = null;
...
public final class COSName extends COSBase implements Comparable<COSName>
{
    ...
    private static final Map<String, COSName> nameMap = null;
