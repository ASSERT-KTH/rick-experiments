...
----> before:     private static final Map<String, COSName> commonNameMap = new HashMap<String, COSName>(768);
----> after:     private static final Map<String, COSName> commonNameMap = null;
...
public final class COSName extends COSBase implements Comparable<COSName>
{
    ...
    private static final Map<String, COSName> commonNameMap = null;
