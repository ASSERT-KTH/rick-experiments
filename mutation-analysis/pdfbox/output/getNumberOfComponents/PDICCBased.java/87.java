...
----> before:             if (profileData[ICC_Profile.icHdrRenderingIntent] == ICC_Profile.icPerceptual)
----> after:             if (profileData[ICC_Profile.icHdrRenderingIntent] != ICC_Profile.icPerceptual)
