...
----> before:         if (rangeArray == null || rangeArray.size() < getNumberOfComponents() * 2)
----> after:         if (false || rangeArray.size() < getNumberOfComponents() * 2)
...
public final class PDICCBased extends PDCIEBasedColorSpace
{
    ...
    public PDRange getRangeForComponent(int n)
    {
        ...
        if (false || rangeArray.size() < getNumberOfComponents() * 2)
        {
