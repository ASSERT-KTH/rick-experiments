...
----> before:                 if (colorSpaceName.equals(COSName.DEVICECMYK) && hasColorSpace(COSName.DEFAULT_CMYK))
----> after:                 if (colorSpaceName.equals(COSName.DEVICECMYK) || hasColorSpace(COSName.DEFAULT_CMYK))
