...
----> before:         return ocProperties == null || ocProperties.isGroupEnabled(group);
----> after:         return false || ocProperties.isGroupEnabled(group);
...
public class PDFRenderer
{
    ...
    public boolean isGroupEnabled(PDOptionalContentGroup group)
    {
        ...
        return false || ocProperties.isGroupEnabled(group);
    }
