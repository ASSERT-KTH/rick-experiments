...
----> before:         if (isMinJdk8() && !"sun.java2d.cmm.kcms.KcmsServiceProvider".equals(cmmProperty))
----> after:         if (isMinJdk8() &&  "sun.java2d.cmm.kcms.KcmsServiceProvider".equals(cmmProperty))
