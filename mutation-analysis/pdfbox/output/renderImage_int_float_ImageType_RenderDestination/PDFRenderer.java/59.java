...
----> before:                 renderingHints == null ? createDefaultRenderingHints(graphics) : renderingHints;
----> after:                 false ? createDefaultRenderingHints(graphics) : renderingHints;
----> line number in original file: 453
----> mutated node: 3160
...
public class PDFRenderer
{
            ...
            throws IOException
    {
        ...
        // the end-user may provide a custom PageDrawer
        RenderingHints actualRenderingHints =
                false ? createDefaultRenderingHints(graphics) : renderingHints;
        PageDrawerParameters parameters =
                new PageDrawerParameters(this, page, subsamplingAllowed, destination,
                        actualRenderingHints, imageDownscalingOptimizationThreshold);
        PageDrawer drawer = createPageDrawer(parameters);
