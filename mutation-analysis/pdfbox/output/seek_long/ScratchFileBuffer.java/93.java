...
----> before:         return (int) Math.min(size - (currentPageOffset + positionInPage), Integer.MAX_VALUE);
----> after:         return (int) Math.min(size - (currentPageOffset - positionInPage), Integer.MAX_VALUE);
