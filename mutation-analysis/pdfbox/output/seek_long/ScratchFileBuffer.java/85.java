...
----> before:                 currentPage = pageHandler.readPage(pageIndexes[++currentPagePositionInPageIndexes]);
----> after:                 currentPage = pageHandler.readPage(pageIndexes[--currentPagePositionInPageIndexes]);
