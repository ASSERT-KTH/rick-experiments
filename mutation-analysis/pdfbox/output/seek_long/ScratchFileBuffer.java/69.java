...
----> before:         if ((seekToPosition >= currentPageOffset) && (seekToPosition <= currentPageOffset + pageSize))
----> after:         if ((seekToPosition < currentPageOffset) && (seekToPosition <= currentPageOffset + pageSize))
