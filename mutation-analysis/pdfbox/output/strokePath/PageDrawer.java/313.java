...
----> before:         if (annotation.isNoRotate() && getCurrentPage().getRotation() != 0)
----> after:         if (annotation.isNoRotate() || getCurrentPage().getRotation() != 0)
----> line number in original file: 1524
----> mutated node: 5179
