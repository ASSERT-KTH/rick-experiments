...
----> before:         if (deviceType == GraphicsDevice.TYPE_PRINTER && !annotation.isPrinted())
----> after:         if (deviceType == GraphicsDevice.TYPE_PRINTER || !annotation.isPrinted())
----> line number in original file: 1493
----> mutated node: 5153
