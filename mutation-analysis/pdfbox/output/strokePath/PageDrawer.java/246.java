...
----> before:                 glyph2D = new CIDType0Glyph2D(cidType0Font); // todo: could be null (need incorporate fallback)
----> after:                 glyph2D = null; // todo: could be null (need incorporate fallback)
    ...
    private Glyph2D createGlyph2D(PDFont font) throws IOException
    {
        ...
        else if (font instanceof PDType0Font)
        {
            ...
            else if (type0Font.getDescendantFont() instanceof PDCIDFontType0)
            {
                ...
                glyph2D = null; // todo: could be null (need incorporate fallback)
            }
        }
        else
        {
