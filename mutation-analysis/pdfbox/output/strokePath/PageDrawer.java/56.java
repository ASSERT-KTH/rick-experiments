...
----> before:         at.scale(1.0 / Math.abs(m.getScalingFactorX()), 1.0 / Math.abs(m.getScalingFactorY()));
----> after:         at.scale(1.0 / Math.abs(m.getScalingFactorX()), 1.0 * Math.abs(m.getScalingFactorY()));
