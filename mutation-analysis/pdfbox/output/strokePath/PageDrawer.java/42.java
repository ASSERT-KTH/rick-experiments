...
----> before:                 imageTransform.scale(1f / w * image.getWidth(), 1f / h * image.getHeight());
----> after:                 imageTransform.scale(1f / w * image.getWidth(), 1f * h * image.getHeight());
----> line number in original file: 1327
----> mutated node: 18045
