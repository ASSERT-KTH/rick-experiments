...
----> before:         if (deviceType == GraphicsDevice.TYPE_RASTER_SCREEN && annotation.isNoView())
----> after:         if (deviceType != GraphicsDevice.TYPE_RASTER_SCREEN && annotation.isNoView())
----> line number in original file: 1497
----> mutated node: 6263
