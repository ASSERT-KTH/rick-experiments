...
----> before:             Rectangle2D bounds = shading.getBounds(new AffineTransform(), ctm);
----> after:             Rectangle2D bounds = shading.getBounds(null, ctm);
----> line number in original file: 1458
----> mutated node: 17256
...
public class PageDrawer extends PDFGraphicsStreamEngine
{
    ...
    */
    ...
    public void shadingFill(COSName shadingName) throws IOException
    {
        ...
        {
            Rectangle2D bounds = shading.getBounds(null, ctm);
            if (bounds != null)
            {
