...
----> before:             boolean needsBackdrop = !isSoftMask && !form.getGroup().isIsolated() &&
----> after:             boolean needsBackdrop = !isSoftMask && !form.getGroup().isIsolated() ||
----> line number in original file: 1725
----> mutated node: 14182
