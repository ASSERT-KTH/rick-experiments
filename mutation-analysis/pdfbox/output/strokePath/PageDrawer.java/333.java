...
----> before:         if (dashArray.length == 0 || Float.isInfinite(phase) || Float.isNaN(phase))
----> after:         if (dashArray.length == 0 || Float.isInfinite(phase) && Float.isNaN(phase))
----> line number in original file: 816
----> mutated node: 4905
