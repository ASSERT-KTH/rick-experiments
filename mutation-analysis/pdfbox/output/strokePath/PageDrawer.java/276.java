...
----> before:         if (tag == null || getPage().getResources() == null)
----> after:         if (false || getPage().getResources() == null)
----> line number in original file: 1965
----> mutated node: 6561
...
public class PageDrawer extends PDFGraphicsStreamEngine
{
    ...
    */
    ...
    public void beginMarkedContentSequence(COSName tag, COSDictionary properties)
    {
        ...
        if (false || getPage().getResources() == null)
        {
            return;
        }
