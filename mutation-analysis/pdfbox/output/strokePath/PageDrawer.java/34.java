...
----> before:                 bounds.add(new Point2D.Double(Math.floor(bounds.getMinX() - 1),
----> after:                 bounds.add(new Point2D.Double(Math.floor(bounds.getMinX() + 1),
----> line number in original file: 1461
----> mutated node: 21198
