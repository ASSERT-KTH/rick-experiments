...
----> before:                 BufferedImage renderedPaint = new BufferedImage(w, h, BufferedImage.TYPE_INT_ARGB);
----> after:                 BufferedImage renderedPaint = null;
----> line number in original file: 1155
----> mutated node: 18691
    ...
    public void drawImage(PDImage pdImage) throws IOException
    {
        ...
        if (pdImage.isStencil())
        {
            if (getGraphicsState().getNonStrokingColor().getColorSpace() instanceof PDPattern)
            {
                ...
                BufferedImage renderedPaint = null;
