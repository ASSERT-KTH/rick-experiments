...
----> before:             float scaleX = Math.abs(imageTransformMatrix.getScalingFactorX() * graphicsTransformMatrix.getScalingFactorX());
----> after:             float scaleX = Math.abs(imageTransformMatrix.getScalingFactorX() / graphicsTransformMatrix.getScalingFactorX());
----> line number in original file: 1309
----> mutated node: 16006
