...
----> before:                 BufferedImage renderedMask = new BufferedImage(w, h, BufferedImage.TYPE_INT_RGB);
----> after:                 BufferedImage renderedMask = null;
----> line number in original file: 1165
----> mutated node: 18716
    ...
    public void drawImage(PDImage pdImage) throws IOException
    {
        ...
        if (pdImage.isStencil())
        {
            if (getGraphicsState().getNonStrokingColor().getColorSpace() instanceof PDPattern)
            {
                ...
                BufferedImage renderedMask = null;
