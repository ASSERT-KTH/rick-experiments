...
----> before:             DataBuffer buffer = new DataBufferByte(width * height * bands);
----> after:             DataBuffer buffer = new DataBufferByte(width * height / bands);
----> line number in original file: 1850
----> mutated node: 19112
