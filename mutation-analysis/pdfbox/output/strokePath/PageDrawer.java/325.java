...
----> before:             boolean isScaledUp = bim.getWidth() < Math.round(at.getScaleX()) ||
----> after:             boolean isScaledUp = bim.getWidth() < Math.round(at.getScaleX()) &&
----> line number in original file: 1112
----> mutated node: 13680
