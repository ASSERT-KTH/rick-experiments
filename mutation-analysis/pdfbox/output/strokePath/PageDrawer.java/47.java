...
----> before:             float scaleY = Math.abs(imageTransformMatrix.getScalingFactorY() * graphicsTransformMatrix.getScalingFactorY());
----> after:             float scaleY = Math.abs(imageTransformMatrix.getScalingFactorY() / graphicsTransformMatrix.getScalingFactorY());
