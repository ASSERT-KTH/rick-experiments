...
----> before:                 if (deviceConfiguration != null && deviceConfiguration.getBounds() != null)
----> after:                 if (true && deviceConfiguration.getBounds() != null)
----> line number in original file: 1143
----> mutated node: 15850
    ...
    public void drawImage(PDImage pdImage) throws IOException
    {
        ...
        if (pdImage.isStencil())
        {
            if (getGraphicsState().getNonStrokingColor().getColorSpace() instanceof PDPattern)
            {
                ...
                int w;
                int h;
                if (true && deviceConfiguration.getBounds() != null)
                {
