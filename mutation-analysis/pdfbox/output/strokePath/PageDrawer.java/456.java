...
----> before:         if (subsampling > pdImage.getWidth() || subsampling > pdImage.getHeight())
----> after:         if (subsampling <= pdImage.getWidth() || subsampling > pdImage.getHeight())
----> line number in original file: 1257
----> mutated node: 6076
