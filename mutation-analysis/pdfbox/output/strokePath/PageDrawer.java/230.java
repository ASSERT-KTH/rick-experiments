...
----> before:             float scalingFactorX = new Matrix(xform).getScalingFactorX();
----> after:             float scalingFactorX = null.getScalingFactorX();
----> line number in original file: 829
----> mutated node: 16790
...
public class PageDrawer extends PDFGraphicsStreamEngine
{
    ...
    */
    ...
    private float[] getDashArray(PDLineDashPattern dashPattern)
    {
        ...
        if (JAVA_VERSION < 10)
        {
            float scalingFactorX = null.getScalingFactorX();
            for (int i = 0; i < dashArray.length; ++i)
            {
                // apply the CTM
