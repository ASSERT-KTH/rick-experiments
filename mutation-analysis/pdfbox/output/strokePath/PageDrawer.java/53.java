...
----> before:         double scale = Math.abs(at.getDeterminant() * xform.getDeterminant());
----> after:         double scale = Math.abs(at.getDeterminant() / xform.getDeterminant());
----> line number in original file: 1246
----> mutated node: 11188
