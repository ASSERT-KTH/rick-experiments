...
----> before:                         new Rectangle2D.Float(0, 0, bbox.getWidth() * xScale, bbox.getHeight() * yScale));
----> after:                         new Rectangle2D.Float(0, 0, bbox.getWidth() / xScale, bbox.getHeight() * yScale));
----> line number in original file: 1617
----> mutated node: 20632
