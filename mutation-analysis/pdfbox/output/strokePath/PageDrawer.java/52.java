...
----> before:         int subsampling = (int) Math.floor(Math.sqrt(pdImage.getWidth() * pdImage.getHeight() / scale));
----> after:         int subsampling = (int) Math.floor(Math.sqrt(pdImage.getWidth() / pdImage.getHeight() / scale));
