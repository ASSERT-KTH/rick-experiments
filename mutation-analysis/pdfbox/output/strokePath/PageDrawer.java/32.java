...
----> before:                 bounds.add(new Point2D.Double(Math.ceil(bounds.getMaxX() + 1),
----> after:                 bounds.add(new Point2D.Double(Math.ceil(bounds.getMaxX() - 1),
----> line number in original file: 1463
----> mutated node: 21206
