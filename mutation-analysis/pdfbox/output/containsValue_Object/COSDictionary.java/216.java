...
----> before:     protected Map<COSName, COSBase> items = new SmallMap<COSName, COSBase>();
----> after:     protected Map<COSName, COSBase> items = null;
...
public class COSDictionary extends COSBase implements COSUpdateInfo
{
     ...
     */
    protected Map<COSName, COSBase> items = null;
