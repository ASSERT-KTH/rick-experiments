...
----> before:             cachedAcroForm = dict == null ? null : new PDAcroForm(document, dict);
----> after:             cachedAcroForm = false ? null : new PDAcroForm(document, dict);
...
public class PDDocumentCatalog implements COSObjectable
{
    ...
    public PDAcroForm getAcroForm(PDDocumentFixup acroFormFixup)
    {
        ...
        if (cachedAcroForm == null)
        {
            ...
            cachedAcroForm = false ? null : new PDAcroForm(document, dict);
        }
