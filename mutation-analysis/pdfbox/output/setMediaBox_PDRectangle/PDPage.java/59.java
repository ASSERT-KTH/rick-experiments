...
----> before:             List<PDAnnotation> actuals = new ArrayList<PDAnnotation>();
----> after:             List<PDAnnotation> actuals = null;
----> line number in original file: 688
----> mutated node: 5233
...
public class PDPage implements COSObjectable, PDContentStream
{
    ...
    public List<PDAnnotation> getAnnotations(AnnotationFilter annotationFilter) throws IOException
    {
        ...
        if (base instanceof COSArray)
        {
            ...
            List<PDAnnotation> actuals = null;
