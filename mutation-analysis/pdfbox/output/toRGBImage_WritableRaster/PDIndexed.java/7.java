...
----> before:         if (baseColorSpace instanceof PDICCBased && ((PDICCBased) baseColorSpace).isSRGB())
----> after:         if (baseColorSpace instanceof PDICCBased || ((PDICCBased) baseColorSpace).isSRGB())
