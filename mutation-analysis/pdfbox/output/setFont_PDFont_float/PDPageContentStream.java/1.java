...
----> before:             nonStrokingColorSpaceStack.setElementAt(colorSpace, nonStrokingColorSpaceStack.size() - 1);
----> after:             nonStrokingColorSpaceStack.setElementAt(colorSpace, nonStrokingColorSpaceStack.size() + 1);
----> line number in original file: 2606
----> mutated node: 14945
