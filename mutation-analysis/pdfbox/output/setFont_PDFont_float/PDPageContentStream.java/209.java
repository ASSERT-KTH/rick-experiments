...
----> before:         if (isOutsideOneInterval(r) || isOutsideOneInterval(g) || isOutsideOneInterval(b))
----> after:         if (isOutsideOneInterval(r) && isOutsideOneInterval(g) || isOutsideOneInterval(b))
----> line number in original file: 1197
----> mutated node: 8595
