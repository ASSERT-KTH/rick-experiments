...
----> before:         if (isOutside255Interval(c) || isOutside255Interval(m) || isOutside255Interval(y) || isOutside255Interval(k))
----> after:         if (isOutside255Interval(c) || isOutside255Interval(m) || isOutside255Interval(y) && isOutside255Interval(k))
----> line number in original file: 1245
----> mutated node: 7341
