...
----> before:         if (isOutsideOneInterval(c) || isOutsideOneInterval(m) || isOutsideOneInterval(y) || isOutsideOneInterval(k))
----> after:         if (isOutsideOneInterval(c) || isOutsideOneInterval(m) && isOutsideOneInterval(y) || isOutsideOneInterval(k))
----> line number in original file: 1508
----> mutated node: 8819
